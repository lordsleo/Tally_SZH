...
Public Class FrmConSealExam_Edit
...
#Region " Windows 窗体设计器生成的代码 "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(FrmConSealExam_Edit))
        ...
        Me.txtOriginalSealNO.TabIndex = 280
        ...
        Me.cbOgSealCondition.TabIndex = 300
        '
        'FrmConSealExam_Edit
        '
        ...
        Me.Name = "FrmConSealExam_Edit"
        Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen
        Me.Text = "集装箱验封施封信息 修改"
...
#End Region
    ...
    Private Sub FrmConSealExam_Edit_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        On Error GoTo Err
        ...
        If dw.Count > 0 Then
            ...
            cbNewSealNo.Text = Nothing
            strSealNO = ds.Tables(0).Rows(0).Item("NEWSEALNO")
            cbNewSealNo.Text = strSealNO
...
Err:
    ...
    Private Sub btSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btSave.Click
        ...
        strsqlNoCon = "select * from seal_exam where SHIP_ID= '" & Ship_ID & "' and  SEAL_EXAM_ID <> '" & ID & _
            ...
            If Trim(txtNo.Text) <> "" Then
                If cbContainer.SelectedValue <> Nothing Then
                    If DateDiff(DateInterval.Minute, Me.dtpTimeBegin.Value, Me.dtpTimeEnd.Value) >= 0 Then
                        If cbNewSealNo.SelectedValue <> Nothing Or strNewSeal = "" Or strNewSeal = strSealNO Then
                            Mark = True
                        Else
                            ...
                            If i < dvSealNo.Count Then
                                Mark = True
                            Else
                                MessageBox.Show("请选择新铅封号 或是保持或清空 原来新铅封号！", "提示", MessageBoxButtons.OK, MessageBoxIcon.Information)
                            End If
                        End If
                    Else
    ...
    Private Sub EditSealExam(ByVal strNewSeal As String, ByVal strOldSeal As String)
        ...
        ds.Tables(0).Rows(0).Item("CONTAINER_NO") = Trim(cbContainer.Text)
        ds.Tables(0).Rows(0).Item("NEWSEALNO") = strNewSeal
        ds.Tables(0).Rows(0).Item("ORIGINESEALNO") = strOldSeal
        ds.Tables(0).Rows(0).Item("ORIGINESEALNO_CONDITION") = Me.cbOgSealCondition.SelectedValue
        ...
        'ds.Tables(0).Rows(0).Item("WORKTYPE") = "2"
