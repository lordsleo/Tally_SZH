...
#Region " Windows 窗体设计器生成的代码 "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(Frmnewgoods))
        ...
        Me.C1DBG.Size = New System.Drawing.Size(488, 304)
        ...
        "alScrollGroup=""1"" HorizontalScrollGroup=""1""><Height>300</Height><CaptionStyle pa" & _
        ...
        "nt=""Normal"" me=""Style1"" /><ClientRect>0, 0, 484, 300</ClientRect><BorderSide>0</" & _
        ...
        "ecSelWidth><ClientArea>0, 0, 484, 300</ClientArea><PrintPageHeaderStyle parent=""" & _
...
#End Region
    ...
    Private Sub Frm_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Call preview("WL1_4") '*****************权限设计 '*************要修改模块号
        Me.Text = Me.Text & "_" & G_DeptName
        FirmStr = " Order by px "  '" Use_Comp Like '" & Trim(G_DeptCode) & "%' and Hide_Company Like '" & Trim(G_Company) & "%' order by ID DESC" '设计初始条件  在检索后不改变的条件  '***************要修改 或 2>1
        DynaStr = " 2>1 " ' Code<>'0000' " '设计其它初始条件    在检索后不需要的条件 ***************要修改 或 其它条件
        SelectStr = "   "
    ...
    Private Sub myDataGrid(ByVal SelStr As String, ByVal Sql As String)
        ...
        Try
            '不显示的列名在最前面
            strsql = "select " & SelStr & " * from view_newgoods where " & Sql '******要修改

            Me.C1DBG.DataSource = Getdata(strsql, ds)  ' class dbcontrol getdata fuction
            ColNum = 1 '不显示的列数 '******要修改

            'For j = 1 To 3 'ds.Tables(0).Columns.Count - 1
            '    Me.C1DBG.Columns(j).FilterDropdown = True
            'Next

            Table_Name = "view_newgoods" '操作的数据库表名 ''******要修改
...
Err:
    ...
    Private Sub mnuDelete_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles mnuDelete.Click
        If ds.Tables(0).Rows.Count > 0 Then
            Dim FrmDelete As New Frmnewgoods_Del   '***********要修改
    ...
    Private Sub mnuEdit_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles mnuEdit.Click
        If ds.Tables(0).Rows.Count > 0 Then
            Dim FrmEdit As New Frmnewgoods_Edit   '***********要修改
    ...
    Private Sub mnuAdd_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles mnuAdd.Click
        Dim FrmAdd As New Frmnewgoods_Add   '***********要修改
        If ds.Tables(0).Rows.Count > 0 Then
            ID = CType(Me.C1DBG.Columns.Item("ID").Text.ToString, Integer)
        Else
            ID = -1
    ...
    Private Sub mnuQuery_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles mnuQuery.Click
        'If ds.Tables(0).Rows.Count > 0 Then
        '    Dim FrmQuery As New Frmnewgoods_Query() '***********要修改
        '    ID = CType(Me.C1DBG.Columns.Item("ID").Text.ToString, Integer)
        '    FrmQuery.ShowDialog()
        'End If
    End Sub
