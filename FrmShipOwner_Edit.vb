...
Public Class FrmShipOwner_Edit
    ...
    Private Sub btResume_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btResume.Click
        Try
            If MsgBox("你确认要修改吗？", MsgBoxStyle.YesNo, "提示") = MsgBoxResult.Yes Then
                Call OperateHistory(G_DeptName, Now, G_User, "修改", "Code_Ship_Owner", Trim(txtID.Text), "ShipOwner_ID")


                ds.Tables(0).Rows(0).Item("CODE_ShipOwner") = Trim(txtCode.Text)
                ds.Tables(0).Rows(0).Item("ShipOwner_CHA") = Trim(txtCHA.Text)
                ds.Tables(0).Rows(0).Item("ShipOwner_ENG") = Trim(txtENG.Text)
                ...
                ds.Tables(0).Rows(0).Item("SHIPOWNER_SHORT") = Trim(txtShort.Text)
