...
Public Class FrmCargoPackTest_Edit
...
#Region " Windows 窗体设计器生成的代码 "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.txtLeastWeight.TabIndex = 575
        ...
        Me.txtErrorAmount.TabIndex = 570
        ...
        Me.txtAverageWeight.TabIndex = 573
        ...
        Me.txtStandardWeight.TabIndex = 572
        ...
        Me.txtEligibleRate.TabIndex = 571
        ...
        Me.Name = "FrmCargoPackTest_Edit"
        Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen
        Me.Text = "散货灌包工班质检日报 修改"
...
#End Region
    ...
    Private Sub FrmCargoPackTest_Edit_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        On Error GoTo Err
...
Err:
    ...
    Private Sub btSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btSave.Click
        ...
        sqlExist = "select * from CARGO_PACK_Sample WHERE (CARGO_PACK_Sample_ID <> '" & ID & "') and (SHIP_ID = '" & Ship_ID & "') AND (BillNO = '" & Me.cbBillNo.SelectedValue & "') AND (YEAR(TestDate) = '" & TestDate.Year & "') AND (MONTH(TestDate) = '" & TestDate.Month & "') AND (DAY(TestDate) = '" & TestDate.Day & "') AND (DayOrNight = '" & Me.cbDayOrNight.SelectedValue & "') AND (P_M_TYPE = '" & Me.cbPMType.SelectedValue & "')"
        Try
                ...
                If Me.txtTimeBegin.Text Like "[0-1]#[0-5]#" Or Me.txtTimeBegin.Text Like "2[0-3][0-5]#" Then
                    If Me.txtTimeEnd.Text Like "[0-1]#[0-5]#" Or Me.txtTimeBegin.Text Like "2[0-3][0-5]#" Then
                        ...
                        ElseIf SetNumValue("LEAST_WEIGHT", txtLeastWeight.Text, "最低件重") = False Then
                            ...
                            Exit Sub
                        End If
                        ds.Tables(0).Rows(0).Item("BillNO") = cbBillNo.SelectedValue
                        ds.Tables(0).Rows(0).Item("TestDate") = Me.cbTestDate.SelectedValue
                        ds.Tables(0).Rows(0).Item("DayOrNight") = Me.cbDayOrNight.SelectedValue
                        ds.Tables(0).Rows(0).Item("TIMEFROM") = Me.txtTimeBegin.Text
                        ds.Tables(0).Rows(0).Item("TIMETO") = Me.txtTimeEnd.Text
                        'TestCodeNo
                        ds.Tables(0).Rows(0).Item("P_M_TYPE") = cbPMType.SelectedValue
                        ds.Tables(0).Rows(0).Item("QUALITY") = Trim(txtQuality.Text)
                        ds.Tables(0).Rows(0).Item("CAUSE") = Trim(txtCause.Text)
                        ds.Tables(0).Rows(0).Item("RESULT") = Trim(txtResult.Text)
                        ds.Tables(0).Rows(0).Item("TEST_PERSON") = Trim(txtTestPerson.Text)
                        ...
                        If MessageBox.Show("确认要修改吗？", "警告提示", MessageBoxButtons.OKCancel, MessageBoxIcon.Asterisk, MessageBoxDefaultButton.Button2) = DialogResult.OK Then
                            If Filldata(sqlExist).Count = 0 Then
                                '记录操作日志
                                Call OperateHistory(G_DeptName, Now, G_User, "修改", "CARGO_PACK_Sample", Trim(txtID.Text), "CARGO_PACK_Sample_ID")
                                sqlda.Update(ds)
                                Me.Close()
                            Else
                                Me.cbBillNo.Focus()
