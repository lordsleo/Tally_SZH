...
Public Class FrmCARGO_DAILY_REPORT
...
#Region " Windows 窗体设计器生成的代码 "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(FrmCARGO_DAILY_REPORT))
        ...
        Me.GBV.Name = "GBV"
        Me.GBV.Size = New System.Drawing.Size(174, 435)
        Me.GBV.TabIndex = 3
        ...
        Me.ToolBarV.Location = New System.Drawing.Point(3, 394)
        ...
        Me.C1DBGV.Size = New System.Drawing.Size(168, 327)
        ...
        ", 0, 164, 323</ClientRect><BorderSide>0</BorderSide><CaptionStyle parent=""Style2" & _
        ...
        "64, 323</ClientArea></Blob>"
        '
        'GB
        '
        Me.GB.Controls.AddRange(New System.Windows.Forms.Control() {Me.C1DBG, Me.LabREMARKS, Me.Label, Me.ToolBar})
        Me.GB.Dock = System.Windows.Forms.DockStyle.Fill
        Me.GB.Location = New System.Drawing.Point(174, 0)
        Me.GB.Name = "GB"
        Me.GB.Size = New System.Drawing.Size(540, 435)
        Me.GB.TabIndex = 4
        Me.GB.TabStop = False
        '
        'C1DBG
        ...
        'btResure
        '
        Me.btResure.Location = New System.Drawing.Point(128, 370)
        ...
        'txtVoyage
        '
        Me.txtVoyage.Location = New System.Drawing.Point(38, 370)
        ...
        'Label2
        '
        Me.Label2.Location = New System.Drawing.Point(6, 374)
        ...
        'txtShipName
        '
        Me.txtShipName.Location = New System.Drawing.Point(38, 346)
...
#End Region
    ...
    Private Sub FrmCARGO_DAILY_REPORT_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
...
Err:
    ...
    '        Me.C1DBG.Columns.Item(ColNum).FooterText = "合计 共" & dsdaily.Tables(0).Rows.Count & "条"
    '        Do While i < Me.C1DBG.Columns.Count
    '            j = 0
    '            For j = 0 To dset.Tables(0).Rows.Count - 1
    ...
    '        Dim FrmDelete As New FrmCARGO_WAITFOR_DELETE() '***********要修改
    ...
    Private Sub eng()
        ...
        Try
            ...
            xlsheet.Cells(9, 7) = dsdaily.Tables(2).Rows(0).Item("berth")
            xlsheet.Cells(9, 10) = Hour(dsdaily.Tables(3).Rows(0).Item("timefrom")) & ":00"
            xlsheet.Cells(9, 12) = Hour(dsdaily.Tables(4).Rows(0).Item("timeto")) & ":00"
