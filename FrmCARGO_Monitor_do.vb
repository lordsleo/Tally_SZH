...
Public Class FrmCARGO_Monitor_do
...
#End Region
    ...
    Private Sub BtDO_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtDO.Click
        ...
        If Len(Combunload.SelectedValue) > 0 Then
            ...
            '    trade = ds_sship.Tables(0).Rows(0).Item("s_trade")
                ...
                '    Me.Close()
                'ElseIf trade = "2" Then
            dw = Getdata("exec SP_CARGO_Monitor_new '" & Ship_ID & "','" & Combunload.SelectedValue & "'", DS_DO)
                mark = "1"
                If ds_eng.Tables(0).Rows.Count > 0 Then
    ...
    Private Sub FrmCARGO_Monitor_do_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
