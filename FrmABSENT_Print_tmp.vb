...
#End Region
    ...
    Private Sub FrmABSENT_Print_tmp_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        FirmStr = " Order by work_type,WORK_NO,ABSENT_month desc "  '设计初始条件  在检索后不改变的条件 
        DynaStr = " DEPT_CODE= '" & G_DeptCode & "'  and datediff(MM,ABSENT_month,GETDATE())=1 "  '设计其它初始条件    在检索后不需要的条件 ***************要修改 或 其它条件
        SelectStr = " Top 100 "
