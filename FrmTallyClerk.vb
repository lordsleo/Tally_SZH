...
#Region " Windows 窗体设计器生成的代码 "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(FrmTallyClerk))
        ...
        Me.ToolBar.Size = New System.Drawing.Size(444, 41)
        ...
        Me.C1DBG.Size = New System.Drawing.Size(444, 260)
        ...
        " HorizontalScrollGroup=""1""><ClientRect>0, 0, 440, 256</ClientRect><BorderSide>0<" & _
        ...
        "</DefaultRecSelWidth><ClientArea>0, 0, 440, 256</ClientArea><PrintPageHeaderStyl" & _
...
#End Region
    ...
    Private Sub Frm_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Call preview("WL1_28") '*****************权限设计 '*************要修改模块号
        Me.Text = Me.Text & "_" & G_DeptName
        If Trim(G_DeptCode) = "26.11.11" Then
            FirmStr = "and (Dept_Code like '" & Trim(G_DeptCode) & "%' or Dept_Code = '29.11.11') Order by Work_NO "
        Else
            FirmStr = "and Dept_Code Like '" & Trim(G_DeptCode) & "%' Order by Work_NO "
        End If
        '" Use_Comp Like '" & Trim(G_DeptCode) & "%' and Hide_Company Like '" & Trim(G_Company) & "%' order by ID DESC" '设计初始条件  在检索后不改变的条件  '***************要修改 或 2>1
    ...
    Private Sub myDataGrid(ByVal SelStr As String, ByVal Sql As String)
        ...
        Try
            '不显示的列名在最前面
            strsql = "select " & SelStr & " * from view_TallyClerk where " & Sql '******要修改

            Me.C1DBG.DataSource = Getdata(strsql, ds)  ' class dbcontrol getdata fuction
            ColNum = 16 '不显示的列数 '******要修改
            Table_Name = "view_TallyClerk" '操作的数据库表名 ''******要修改

            For i = 0 To ColNum - 1 '设计部显示的列
                Me.C1DBG.Splits(0).DisplayColumns.Item(i).Visible = False
            Next
            Me.C1DBG.Splits(0).DisplayColumns.Item(17).Visible = False
            'Me.C1DBG.Splits(0).DisplayColumns.Item(18).Visible = False



           
            Me.C1DBG.Columns.Item("BirthDay").NumberFormat = "yyyy/MM/dd"
...
Err:
    ...
    Private Sub mnuDelete_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles mnuDelete.Click
        If ds.Tables(0).Rows.Count > 0 Then
            Dim FrmDelete As New FrmTallyClerk_Delete() '***********要修改
    ...
    Private Sub mnuEdit_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles mnuEdit.Click
        If ds.Tables(0).Rows.Count > 0 Then
            Dim FrmEdit As New FrmTallyClerk_Edit() '***********要修改
    ...
    Private Sub mnuAdd_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles mnuAdd.Click
        Dim FrmAdd As New FrmTallyClerk_Add() '***********要修改
        If ds.Tables(0).Rows.Count > 0 Then
            ID = CType(Me.C1DBG.Columns.Item("ID").Text.ToString, Integer)
        Else
            ID = -1
    ...
    Private Sub mnuQuery_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles mnuQuery.Click
        If ds.Tables(0).Rows.Count > 0 Then
            Dim FrmQuery As New FrmTallyClerk_Query() '***********要修改
            ID = CType(Me.C1DBG.Columns.Item("ID").Text.ToString, Integer)
            FrmQuery.ShowDialog()
        End If
    End Sub
