...
Public Class FRMCARGO_CON_YEARTALLY
...
#Region " Windows 窗体设计器生成的代码 "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(FRMCARGO_CON_YEARTALLY))
        ...
        Me.C1DBG.Size = New System.Drawing.Size(534, 368)
        ...
        "roup=""1""><ClientRect>0, 0, 530, 364</ClientRect><BorderSide>0</BorderSide><Capti" & _
        ...
        "th><ClientArea>0, 0, 530, 364</ClientArea></Blob>"
        '
        'FRMCARGO_CON_YEARTALLY
        '
        ...
        Me.Menu = Me.MainMenu
        Me.Name = "FRMCARGO_CON_YEARTALLY"
        Me.Text = "分部门理货统计表"
...
#End Region
    ...
    Private Sub FRMCARGO_CON_YEARTALLY_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        DS_DO.Reset()
        dw = Getdata("exec SP_YEARTALLY '" & Now & "','" & G_DeptCode & "'", DS_DO)
        LISTTIME = Now
    ...
    Private Sub myDataGrid(ByVal SelStr As String, ByVal Sql As String)
        ...
        Try
            ...
            Me.C1DBG.Columns.Item("ship").Caption = "船名"
            Me.C1DBG.Columns.Item("amount").Caption = "件数"
            Me.C1DBG.Columns.Item("tons").Caption = "吨数"
            Me.C1DBG.Columns.Item("agent").Caption = "船/货代"
            Me.C1DBG.Columns.Item("worktime_end").Caption = "月份"
    ...
    Private Sub SetColumnWidth()
        ...
        For j = 0 To Me.C1DBG.Columns.Count - 1
            ...
            Else
                If Me.C1DBG.Splits(0).DisplayColumns.Item(j).Width > 200 Then
                    Me.C1DBG.Splits(0).DisplayColumns.Item(j).Width = 200
                End If
            End If
...
Err:
    ...
    Private Sub ToolBar_ButtonClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.ToolBarButtonClickEventArgs) Handles ToolBar.ButtonClick
        Select Case Me.ToolBar.Buttons.IndexOf(e.Button)
            Case 0
                Try
                    Dim frm As New FRMCARGO_CON_YEARTALLY_DO()
                    frm.ShowDialog()
                    Call myDataGrid(SelectStr, SqlStr)
                Catch ex As Exception
                    MsgBox(ex.Message)
    ...
    Private Sub china()
        ...
        Try
            ...
            xlsheet = CType(xlbook.Worksheets("理货统计表"), Excel.Worksheet)
            xlapp.DisplayAlerts = False
            xlsheet.Application.Visible = True

            If Len(LISTTIME) > 0 Then
                xlsheet.Cells(2, 2) = Year(LISTTIME) & "年"
            End If
