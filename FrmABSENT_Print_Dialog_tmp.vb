...
Public Class FrmABSENT_Print_Dialog_tmp
...
#Region " Windows 窗体设计器生成的代码 "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.DTPABSENTDATE.Location = New System.Drawing.Point(78, 30)
        ...
        'btQuit
        '
        Me.btQuit.Location = New System.Drawing.Point(100, 64)
        ...
        'btResume
        '
        Me.btResume.Location = New System.Drawing.Point(32, 64)
        ...
        Me.Name = "FrmABSENT_Print_Dialog_tmp"
...
#End Region
    ...
    Private Sub FrmABSENT_Print_Dialog_tmp_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Call FillWORK_TYPE()
    ...
    Private Sub FillWORK_TYPE()
        ...
        sqldc = "SELECT WORK_TYPE FROM WORK_BEGIN WHERE DEPT_CODE='" & GL_Deptflag & "' ORDER BY TIME_FROM, DayNightMark"
