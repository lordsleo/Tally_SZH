...
#Region " Windows 窗体设计器生成的代码 "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.txtDept.TabIndex = 122
        '
        'btQuit
        '
        Me.btQuit.Location = New System.Drawing.Point(105, 90)
        ...
        'btResume
        '
        Me.btResume.Location = New System.Drawing.Point(37, 90)
        ...
        Me.ClientSize = New System.Drawing.Size(206, 117)
    ...
    Private Sub btResume_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btResume.Click
        Try
            ...
            If MsgBox("你确认要修改吗？", MsgBoxStyle.YesNo, "提示") = MsgBoxResult.Yes Then
                Call OperateHistory(G_DeptName, Now, G_User, "修改", "Code_Director", Trim(txtID.Text), "Director_ID")

                ds.Tables(0).Rows(0).Item("Code_Director") = Trim(txtCode.Text)
                ds.Tables(0).Rows(0).Item("Director") = Trim(txtName.Text)
                ds.Tables(0).Rows(0).Item("Dept_Code") = Trim(txtDept.SelectedValue)
