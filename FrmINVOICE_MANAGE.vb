...
Public Class FrmINVOICE_MANAGE
...
#Region " Windows 窗体设计器生成的代码 "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(FrmINVOICE_MANAGE))
...
#End Region
    ...
    Private Sub FrmINVOICE_MANAGE_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Call preview("WL7_2_1") '*****************权限设计 '*************要修改模块号
    ...
    Private Sub myDataGrid(ByVal SelStr As String, ByVal Sql As String)
        ...
        Dim i As Integer
        Try
            strsql = "select " & SelStr & " * from VIEW_INVOICE_MANAGE where " & Sql '******要修改
            Me.C1DBG.DataSource = Getdata(strsql, ds)  ' class dbcontrol getdata fuction
            ColNum = 3 '不显示的列数 '******要修改
            Table_Name = "VIEW_INVOICE_MANAGE" '操作的数据库表名 ''******要修改
            For i = 0 To ColNum - 1
                Me.C1DBG.Splits(0).DisplayColumns.Item(i).Visible = False
            Next

            Me.C1DBG.Columns.Item(3).Caption = "部门名称"
            Me.C1DBG.Columns.Item(4).Caption = "初始发票号"
            Me.C1DBG.Columns.Item(5).Caption = "结束发票号"
            Me.C1DBG.Columns.Item(6).Caption = "当前发票号"
