...
#Region " Windows 窗体设计器生成的代码 "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        'ckShip
        '
        Me.ckShip.Location = New System.Drawing.Point(244, 146)
        Me.ckShip.Name = "ckShip"
        Me.ckShip.Size = New System.Drawing.Size(74, 24)
        Me.ckShip.TabIndex = 151
        Me.ckShip.Text = "船代标志"
        '
        'FrmShipAgent_Add
        '
...
Err:
    ...
    Private Sub btSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btSave.Click
        Try
            ...
            If Getdata("select * from CODE_SHIP_AGENT where CODE_SHIP_AGENT='" & Trim(txtCode.Text) & "'", dsSave).Count > 0 Then
                MsgBox("可能已存在此船舶代理信息,请注意检查!")
                Exit Sub
            End If
            If Len(Trim(txtCode.Text)) > 0 And Len(Trim(txtCHA.Text)) > 0 Then
                ...
                row("CODE_SHIP_AGENT") = Trim(txtCode.Text)
                row("SHIPAGENT_CHA") = Trim(txtCHA.Text)
                row("SHIPAGENT_ENG") = Trim(txtENG.Text)
                ...
                row("SHIPAGENT_SHORT") = Trim(txtShort.Text)
