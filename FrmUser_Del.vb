...
#Region " Windows 窗体设计器生成的代码 "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.CMD_Save.Location = New System.Drawing.Point(42, 158)
        ...
        Me.ClientSize = New System.Drawing.Size(220, 185)
    ...
    Private Sub CMD_Save_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles CMD_Save.Click
        Try
            If MsgBox("你确认要删除吗？", MsgBoxStyle.YesNo, ) = MsgBoxResult.Yes Then
                Call DBControl.OperateHistory(G_DeptName, Now, G_User, "删除", "SYSTEM_USER_TABLE", ID, "USER_ID")
                dv(0).Delete()
                sqlda.Update(ds)
                Me.Close()
            End If
