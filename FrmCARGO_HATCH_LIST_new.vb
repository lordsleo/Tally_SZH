...
#Region " Windows 窗体设计器生成的代码 "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.mnuMakeReport.Text = "生成理货报告报文"
        '
        'mnuHelp
        '
        Me.mnuHelp.Index = 2
        ...
        Me.tbbtnMakeReport.Text = "理货报告"
        '
        'tbbtntrans_cargolist
        '
        Me.tbbtntrans_cargolist.ImageIndex = 11
        Me.tbbtntrans_cargolist.Name = "tbbtntrans_cargolist"
        Me.tbbtntrans_cargolist.Text = "数据转换"
        Me.tbbtntrans_cargolist.ToolTipText = "转换主子结构舱单到原舱单"
        '
        'tbbtnSep3
        '
...
#End Region
    ...
    Private Sub ToolBarV_ButtonClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.ToolBarButtonClickEventArgs) Handles ToolBarV.ButtonClick
        Select Case Me.ToolBarV.Buttons.IndexOf(e.Button)
            ...
            Case 1
                SqlStrShip = "where ((DEPT_CODE LIKE '" & G_DeptCode & "%' and SHIP_STATU in ('2','3','5','0'))  OR (Ship_Statu in ('1') and len(ltrim(BerthNo))=0))  and code_goods<>'2' " '船舶可变的条件设计
...
Err:
    ...
    Private Sub myDataGrid(ByVal SelStr As String, ByVal Sql As String)
        ...
        Try
            ...
            If Hatch_in = 1 Then
                strsql = "select " & SelStr & " SHIP_ID, mid, ID,EDIMark,报文发送, unload_port, mblno, BLNO, GOODS_CHA, GOODS_ENG, PACK_ENG pack_cha, MARK, AMOUNT_ORI, TONS_ORI, MEASURE_ORI SIZE_MEASURE, AMOUNT, Tons GROSS_WEIGHT,VOLUMN, USER_NAME from szh_CARGO_HATCH_LIST_NEW where " & Sql & " order by unload_port, BLNO " '******要修改
            Else
                strsql = "select " & SelStr & " SHIP_ID, mid, ID,EDIMark,报文发送, load_port, mblno, BLNO, GOODS_CHA, GOODS_ENG, PACK_ENG pack_cha, MARK, AMOUNT_ORI, TONS_ORI, MEASURE_ORI SIZE_MEASURE, AMOUNT, Tons GROSS_WEIGHT,VOLUMN, USER_NAME from szh_CARGO_HATCH_LIST_NEW where " & Sql & " order by load_port, BLNO " '******要修改"
            End If
...
Err:
    ...
    Private Sub transcargolist()
        ...
        MsgBox("数据已导入！", MsgBoxStyle.OkOnly, "提示")
    End Sub
    ...
    Private Sub mnuDelete_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles mnuDelete.Click
        If ds.Tables(0).Rows.Count > 0 Then
            Dim FrmDelete As New FrmCargo_hatch_list_new_del   '***********要修改
            Try
    ...
    Private Sub mnuEdit_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles mnuEdit.Click
        If ds.Tables(0).Rows.Count > 0 Then
            Dim FrmEdit As New FrmCargo_hatch_list_new_edit   '***********要修改
    ...
    Private Sub mnuAdd_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles mnuAdd.Click
        Dim FrmAdd As New FrmCargo_hatch_list_new_add   '***********要修改
        'Do
        If ds.Tables(0).Rows.Count > 0 Then
            ID = CType(Me.C1DBG.Columns.Item("mid").Text.ToString, Integer)
        Else
    ...
    Private Sub mnuQuery_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles mnuQuery.Click
        If ds.Tables(0).Rows.Count > 0 Then
            Dim FrmQuery As New FrmCargo_hatch_list_new_query   '***********要修改
            ID = CType(Me.C1DBG.Columns.Item("mid").Text.ToString, Integer)
            FrmQuery.ShowDialog()
        End If
    End Sub
    ...
    Private Sub mnuMakeReport_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles mnuMakeReport.Click
        If ds.Tables(0).Rows.Count > 0 Then
            Dim Frm As New FrmWriteMailReport   '***********要修改
