...
Public Class FrmCargoGoods
    ...
    Public Shared strGoods As String
    Public Shared iTons As Integer
    Public Shared strBerthNo As String
...
#Region " Windows 窗体设计器生成的代码 "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(FrmCargoGoods))
        ...
        Me.MenuItem3.Text = "检索(&F)"
        '
        'MenuItem4
        '
        Me.MenuItem4.Index = -1
        Me.MenuItem4.Text = "帮助(&H)"
        '
        'tbbtnSep2
        '
        ...
        Me.MenuItem5.MenuItems.AddRange(New System.Windows.Forms.MenuItem() {Me.MenuItem3, Me.MenuItem6, Me.MenuItem7, Me.MenuItem8, Me.MenuItem9, Me.MenuItem10, Me.MenuItem2})
        Me.MenuItem5.Text = "文件(&F)"
        '
        'MenuItem6
        '
        Me.MenuItem6.Enabled = False
        Me.MenuItem6.Index = 1
        Me.MenuItem6.Text = "查看(&Q)"
        '
        'MenuItem7
        '
        ...
        Me.MenuItem11.MenuItems.AddRange(New System.Windows.Forms.MenuItem() {Me.MenuItem12, Me.MenuItem13, Me.MenuItem1})
        ...
        Me.MenuItem12.Text = "增加(&A)"
        '
        'MenuItem13
        '
        Me.MenuItem13.Enabled = False
        Me.MenuItem13.Index = 1
        Me.MenuItem13.Text = "编辑(&E)"
        '
        'tbbtnSep3
        '
        ...
        Me.C1DBG.Size = New System.Drawing.Size(540, 296)
        ...
        " HorizontalScrollGroup=""1""><ClientRect>0, 0, 536, 292</ClientRect><BorderSide>0<" & _
        ...
        "</DefaultRecSelWidth><ClientArea>0, 0, 536, 292</ClientArea><PrintPageHeaderStyl" & _
        ...
        "=""1""><ClientRect>0, 0, 156, 289</ClientRect><BorderSide>0</BorderSide><CaptionSt" & _
        ...
        "ClientArea>0, 0, 156, 289</ClientArea><PrintPageHeaderStyle parent="""" me=""Style1" & _
...
#End Region
    ...
    Private Sub FrmCargoGoods_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub C1DBGV_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles C1DBGV.DoubleClick
        ...
        If dsShip.Tables(0).DefaultView.Count > 0 Then
            ...
            If Not IsDBNull(dsShip.Tables(0).Rows(0).Item("GOODS")) Then
                strGoods = Trim(dsShip.Tables(0).Rows(0).Item("GOODS"))    '保存货名
            End If
            If Not IsDBNull(dsShip.Tables(0).Rows(0).Item("Tons")) Then
                iTons = Trim(dsShip.Tables(0).Rows(0).Item("Tons"))                '记录货物重量 
            End If
            If Not IsDBNull(dsShip.Tables(0).Rows(0).Item("BerthNo")) Then
                strBerthNo = Trim(dsShip.Tables(0).Rows(0).Item("BerthNo"))         '记录泊位号
            End If
        End If
        ...
        Call preview("WL3_6_1") '*****************权限设计 '*************要修改模块号
...
Err:
    ...
    Private Sub myDataGrid(ByVal SelStr As String, ByVal Sql As String)
        ...
        Try
            '不显示的列名在最前面
            strsql = "select " & SelStr & " *  from View_CargoGoods  where " & Sql '******要修改

            Me.C1DBG.DataSource = Getdata(strsql, ds)  ' class dbcontrol getdata fuction
            ColNum = 7 '不显示的列数 '******要修改
            Table_Name = "View_CargoGoods" '操作的数据库表名 ''******要修改
...
Err:
    ...
    Private Sub mnuQuery_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles mnuQuery.Click
        'Try
        '    If ds.Tables(0).Rows.Count > 0 Then
        '        Dim FrmQuery As New FrmCargoGoods_Query()     '***********要修改
    ...
    Private Sub mnuAdd_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles mnuAdd.Click
        Dim FrmAdd As New FrmCargoGoods_Add()     '***********要修改
        If ds.Tables(0).Rows.Count > 0 Then
            ID = CType(Me.C1DBG.Columns.Item("ID").Text.ToString, Integer)
        Else
            ID = -1
    ...
    Private Sub mnuEdit_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles mnuEdit.Click
        If ds.Tables(0).Rows.Count > 0 Then
            Dim FrmEdit As New FrmCargoGoods_Edit()   '***********要修改
            Dim Row As Integer
    ...
    Private Sub mnuDelete_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles mnuDelete.Click
        If ds.Tables(0).Rows.Count > 0 Then
            Dim FrmDelete As New FrmCargoGoods_Delete()     '***********要修改
