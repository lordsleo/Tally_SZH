...
Public Class FrmCargo_hatch_list_new_query
...
#Region " Windows 窗体设计器生成的代码 "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(FrmCargo_hatch_list_new_query))
        ...
        Me.BTQUIT.Location = New System.Drawing.Point(262, 384)
        ...
        Me.Button1.Location = New System.Drawing.Point(132, 384)
        ...
        Me.Name = "FrmCargo_hatch_list_new_query"
...
#End Region
    ...
    Private Sub FrmCargo_hatch_list_new_query_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        On Error GoTo Err
        Dim sqlstr As String
        If Hatch_in = 0 Then
            Me.Text = "件杂货进口舱单_查询"       '唛头
        ...
        '新舱单子表信息
        dw = Updatedata(sqlda_sub, "SELECT ID, MID, BLNO, CODE_GOODS, GOODS_CHA, GOODS_ENG, MARK, CODE_PACK, AMOUNT, WEIGHT, VOLUMN, ACCESSORY, Code_Cargo, MARK_NON, USER_NAME FROM CARGO_HATCH_new_DETAIL where mid=" & ID, ds_sub) '1>2 ", ds_sub)  '
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        Try
            If MsgBox("确认要删除吗？", MsgBoxStyle.YesNo, "提示") = MsgBoxResult.Yes Then
                Call OperateHistory(G_DeptName, Now, G_User, "删除", "cargo_hatch_list_new", ID, "cargo_hatch_list_id")
                ds.Tables(0).Rows(0).Delete()
                sqlda.Update(ds)
                ExecSql("delete from CARGO_HATCH_new_DETAIL where MID=" & ID)
