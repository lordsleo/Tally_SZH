...
Imports System.Math
Public Class FrmCargoWaterResult_Edit
...
#Region " Windows 窗体设计器生成的代码 "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.cbPortLoad.TabIndex = 471
        '
        'btQuit
        '
        Me.btQuit.DialogResult = System.Windows.Forms.DialogResult.Cancel
        Me.btQuit.Location = New System.Drawing.Point(214, 458)
        Me.btQuit.Name = "btQuit"
        Me.btQuit.Size = New System.Drawing.Size(65, 24)
        Me.btQuit.TabIndex = 470
        Me.btQuit.Text = "取消"
        '
        'btSave
        '
        Me.btSave.Location = New System.Drawing.Point(146, 458)
        Me.btSave.Name = "btSave"
        Me.btSave.Size = New System.Drawing.Size(65, 24)
        Me.btSave.TabIndex = 469
        Me.btSave.Text = "确认"
        '
        'Label81
        '
        ...
        Me.lbMiddleWater2.TabIndex = 425
        ...
        Me.lbDesWaterTon1.TabIndex = 414
        ...
        Me.lbCorWaterTon1.TabIndex = 413
        ...
        Me.lbMiddleWater1.TabIndex = 411
        ...
        Me.lbVerWaterTon1.TabIndex = 408
        ...
        Me.cbTimeNumBegin.TabIndex = 405
        '
        'txtAmount
        '
        ...
        Me.lbDesWaterTon2.TabIndex = 424
        ...
        Me.lbCorWaterTon2.TabIndex = 428
        ...
        Me.lbVerWaterTon2.TabIndex = 430
...
#End Region
    ...
    Private Sub FrmCargoWaterResult_Edit_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        On Error GoTo Err
            ...
            If Me.cbConsign.SelectedValue <> "00" Then
                If Me.cbPortLoad.SelectedValue <> Me.cbPortUnload.SelectedValue Or cbPortLoad.SelectedValue = "00" Or cbPortUnload.SelectedValue = "00" Then
                    If Me.cbTimeNumBegin.SelectedValue < Me.cbTimeNumEnd.SelectedValue Then
                        sqlExist = "SELECT TimeNumStart, TimeNumEnd FROM CARGO_WATERog WHERE ship_id ='" & Ship_ID & "' and TimeNumStart = '" & Me.cbTimeNumBegin.SelectedValue & "' AND TimeNumEnd = '" & Me.cbTimeNumEnd.SelectedValue & "' and CARGO_WATER_ID <> '" & ID & "'"
                        dvExist = Filldata(sqlExist)
                        If dvExist.Count = 0 Then
                            ds.Tables(0).Rows(0).Item("CODE_CONSIGN_WATER") = Me.cbConsign.SelectedValue
                            ds.Tables(0).Rows(0).Item("Port_FROM") = Me.cbPortLoad.SelectedValue
                            ds.Tables(0).Rows(0).Item("Port_TO") = Me.cbPortUnload.SelectedValue
                            ds.Tables(0).Rows(0).Item("TimeNumStart") = Me.cbTimeNumBegin.SelectedValue
                            ds.Tables(0).Rows(0).Item("TimeNumEnd") = Me.cbTimeNumEnd.SelectedValue
                            If Trim(Me.txtAmount.Text) <> "" Then
                                If IsNumeric(Trim(txtAmount.Text)) Then
                                    ds.Tables(0).Rows(0).Item("Amount") = Decimal.Round(Convert.ToDecimal(Trim(txtAmount.Text)), 2)
                                Else
                            ...
                            If IsNumeric(lbSub1.Text) Then
                                ds.Tables(0).Rows(0).Item("TOTAL_BEGIN") = Decimal.Round(Convert.ToDecimal(Me.lbSub1.Text), 2)
                            End If
                            If IsNumeric(lbSub2.Text) Then
                                ds.Tables(0).Rows(0).Item("TOTAL_END") = Decimal.Round(Convert.ToDecimal(Me.lbSub2.Text), 2)
                            End If
                            If IsNumeric(lbWeightChang.Text) Then
                                ds.Tables(0).Rows(0).Item("TONS_Long") = Decimal.Round(Convert.ToDecimal(Me.lbWeightChang.Text), 2)
                            End If
                            If IsNumeric(lbWeightGong.Text) Then
                                ds.Tables(0).Rows(0).Item("TONS_Gong") = Decimal.Round(Convert.ToDecimal(Me.lbWeightGong.Text), 2)
                            End If
                            ds.Tables(0).Rows(0).Item("WORK_NO") = Me.lbWorker1.Text
                            ...
                            If MessageBox.Show("确定要修改当前记录吗？", "警告提示", MessageBoxButtons.OKCancel, MessageBoxIcon.Warning, MessageBoxDefaultButton.Button2) = DialogResult.OK Then
                                '记录操作日志
                                Call OperateHistory(G_DeptName, Now, G_User, "修改", "CARGO_WATERog", Trim(txtID.Text), "CARGO_WATER_ID")
                                sqlda.Update(ds)
                                Me.Close()
                            End If
                        Else
