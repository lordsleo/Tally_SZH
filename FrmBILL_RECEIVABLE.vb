...
Public Class FrmBILL_RECEIVABLE
...
#Region " Windows 窗体设计器生成的代码 "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(FrmBILL_RECEIVABLE))
        ...
        'ToolBar
        '
        Me.ToolBar.Buttons.AddRange(New System.Windows.Forms.ToolBarButton() {Me.tbbtnFind, Me.tbbtnQuery, Me.tbbtnSep1, Me.tbbtnAdd, Me.tbbtnEdit, Me.tbbtnDelete, Me.tbbtnSep2, Me.tbbtnExport, Me.tbbtnPrint, Me.tbbtnSep3, Me.tbbtnQuit})
        ...
        Me.tbbtnFind.Text = "处理"
        Me.tbbtnFind.ToolTipText = "月末处理"
        '
        'tbbtnQuery
        '
        ...
        Me.tbbtnAdd.Text = "增加"
        Me.tbbtnAdd.ToolTipText = "增加往来单位"
        '
        'tbbtnEdit
        '
        ...
        Me.tbbtnExport.Text = "录入"
        Me.tbbtnExport.ToolTipText = "到款录入"
        '
        'tbbtnSep3
        '
...
#End Region
    ...
    '*********7.6 '***************要修改
    Private Sub FrmBILL_RECEIVABLE_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Me.WindowState = FormWindowState.Maximized
        Call preview("WL7_6") '*****************权限设计 '*************要修改模块号
        Me.Text = Me.Text & "_" & G_DeptName
        FirmStr = " Order by ACCOUNT_COMPANY"
        DynaStr = " " '设计其它初始条件    在检索后不需要的条件 ***************要修改 或 其它条件
        SelectStr = " "
    ...
    Private Sub myDataGrid(ByVal SelStr As String, ByVal Sql As String)
        ...
        Dim i As Integer
        Try
            strsql = "select [ID], [ACCOUNT_COMPANY], [USER_NAME], [SHIPAGENT_CHA], CAST([ACCOUNT_LAST] AS VARCHAR) AS [ACCOUNT_LAST], CAST([ACCOUNT_OCCUR] AS VARCHAR) AS [ACCOUNT_OCCUR], CAST([ACCOUNT_IN] AS VARCHAR) AS [ACCOUNT_IN], CAST([ACCONT_ARREARAGE] AS VARCHAR) AS [ACCONT_ARREARAGE] from VIEW_BILL_RECEIVABLE " 'where " & Sql '******要修改
            Me.C1DBG.DataSource = Getdata(strsql, ds)  ' class dbcontrol getdata fuction
            ColNum = 3 '不显示的列数 '******要修改
            Table_Name = "VIEW_BILL_RECEIVABLE" '操作的数据库表名 ''******要修改
            For i = 0 To ColNum - 1
    ...
    Private Sub SetColumnWidth()
        Try
            ...
            For j = 0 To Me.C1DBG.Columns.Count - 1
                ...
                If Me.C1DBG.Splits(0).DisplayColumns.Item(j).Width < 100 Then
...
Err:
    ...
    Private Sub mnuFind_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles mnuFind.Click
        ...
        Dim ACCONT As String

        ID = CType(Me.C1DBG.Columns.Item("ID").Text.ToString, Integer)

        Getdata("SELECT [ACCONT_ARREARAGE] FROM [BILL_RECEIVABLE] WHERE BILL_RECEIVABLE_ID='" & ID & "'", ds_tmp)
        ACCONT = ds_tmp.Tables(0).Rows(0).Item(0)
        ExecSql("UPDATE [BILL_RECEIVABLE] SET [ACCOUNT_LAST]=" & ACCONT & ", [ACCOUNT_OCCUR]=0, [ACCOUNT_IN]=0, [ACCONT_ARREARAGE]=" & ACCONT & ", [USER_NAME]='" & G_User & "'  WHERE BILL_RECEIVABLE_ID='" & ID & "'")
    ...
    Private Sub mnuDelete_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles mnuDelete.Click
        If ds.Tables(0).Rows.Count > 0 Then
            Dim FrmDelete As New FrmBILL_RECEIVABLE_Delete() '***********要修改
    ...
    Private Sub mnuEdit_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles mnuEdit.Click
        If ds.Tables(0).Rows.Count > 0 Then
            Dim FrmEdit As New FrmBILL_RECEIVABLE_Edit() '***********要修改
    ...
    Private Sub mnuAdd_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles mnuAdd.Click
        ...
        Dim FrmAdd As New FrmBILL_RECEIVABLE_add() '***********要修改
        FrmAdd.ShowDialog()
    ...
    Private Sub mnuQuery_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles mnuQuery.Click
        If ds.Tables(0).Rows.Count > 0 Then
            Dim FrmQuery As New FrmBILL_RECEIVABLE_Query() '***********要修改
            ID = CType(Me.C1DBG.Columns.Item("ID").Text.ToString, Integer)
            FrmQuery.ShowDialog()
        End If
    End Sub
    ...
    Private Sub mnuExport_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles mnuExport.Click
        ...
        Dim FrmExport As New FrmBILL_RECEIVABLE_Export() '***********要修改
