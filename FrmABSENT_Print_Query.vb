...
Public Class FrmABSENT_Print_Query
...
#End Region
    ...
    Private Sub FrmABSENT_Print_Queryog_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Call FillWORK_TYPE()
