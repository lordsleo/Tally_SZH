...
Imports System.Math
Public Class FrmCargoWaterResult
...
#Region " Windows 窗体设计器生成的代码 "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(FrmCargoWaterResult))
...
#End Region
    ...
    Private Sub FrmCargoWaterResult_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub C1DBGV_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles C1DBGV.DoubleClick
        ...
        Call preview("WL6_1_2") '*****************权限设计 '*************要修改模块号
...
Err:
    ...
    Private Sub myDataGrid(ByVal SelStr As String, ByVal Sql As String)
        ...
        Try
            '不显示的列名在最前面
            strsql = "select " & SelStr & " *  from View_WaterResult  where " & Sql '******要修改

            Me.C1DBG.DataSource = Getdata(strsql, ds)  ' class dbcontrol getdata fuction
            ColNum = 9 '不显示的列数 '******要修改
            Table_Name = "View_WaterResult" '操作的数据库表名 ''******要修改
...
Err:
    ...
    Private Sub mnuQuery_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles mnuQuery.Click
        Try
            If ds.Tables(0).Rows.Count > 0 Then
                Dim FrmQuery As New FrmCargoWaterResult_Query()    '***********要修改
    ...
    Private Sub mnuAdd_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles mnuAdd.Click
        Dim FrmAdd As New FrmCargoWaterResult_Add()     '***********要修改
        If ds.Tables(0).Rows.Count > 0 Then
            ID = CType(Me.C1DBG.Columns.Item("ID").Text.ToString, Integer)
        Else
            ID = -1
    ...
    Private Sub mnuEdit_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles mnuEdit.Click
        If ds.Tables(0).Rows.Count > 0 Then
            Dim FrmEdit As New FrmCargoWaterResult_Edit()   '***********要修改
            Dim Row As Integer
    ...
    Private Sub mnuDelete_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles mnuDelete.Click
        If ds.Tables(0).Rows.Count > 0 Then
            Dim FrmDelete As New FrmCargoWaterResult_Delete()    '***********要修改
    ...
    Private Sub GetSheetExcel()
        ...
        Try
            ...
            xlSheet = CType(xlBook.Worksheets(11), Excel.Worksheet)
            xlSheet.Select(11)
            ...
            sqlNational = "SELECT dbo.CODE_NATIONALITY.NATIONALITY_CHA, dbo.CODE_NATIONALITY.NATIONALITY_ENG FROM dbo.CODE_NATIONALITY INNER JOIN dbo.VESSEL ON dbo.CODE_NATIONALITY.NATIONALITY_ENG = dbo.VESSEL.NATIONALITY_CODE WHERE dbo.VESSEL.CHI_VESSEL = '" & Me.C1DBG.Columns("Chi_Vessel").Value & "'"
            dvNational = Filldata(sqlNational)

            'sqlWaterRecord = "SELECT * FROM Cargo_Water WHERE SHIP_ID = '" & Ship_ID & "' AND Flag = '" & Me.C1DBG.Columns("TimeNumStart").Value & "'"
            'dvWaterRecord = Filldata(sqlWaterRecord)
            'xlSheet.Cells(14, 4) = Round(dvWaterRecord.Item(0)("WaterDensity_True"), 2)
            'xlSheet.Cells(15, 4) = Round(dvWaterRecord.Item(0)("Fc"), 2)
            'xlSheet.Cells(16, 4) = Round(dvWaterRecord.Item(0)("Ac"), 2)
            'xlSheet.Cells(17, 4) = Round(dvWaterRecord.Item(0)("Mc"), 2)
            'xlSheet.Cells(18, 4) = Round(dvWaterRecord.Item(0)("DM_WaterDepth"), 2)
            'xlSheet.Cells(19, 4) = Round(dvWaterRecord.Item(0)("WaterTon_Corres"), 2)
            'xlSheet.Cells(20, 4) = Round(dvWaterRecord.Item(0)("WaterTon_Clean_G"), 2)
            'xlSheet.Cells(21, 4) = Round(dvWaterRecord.Item(0)("WaterTon_Density"), 2)

            'xlSheet.Cells(23, 4) = Round(dvWaterRecord.Item(0)("Fuel"), 2)
            'xlSheet.Cells(24, 4) = Round(dvWaterRecord.Item(0)("WaterLight"), 2)
            'xlSheet.Cells(25, 4) = Round(dvWaterRecord.Item(0)("WaterCabin"), 2)
            'xlSheet.Cells(26, 4) = Round(dvWaterRecord.Item(0)("ConstNum"), 2)
            'xlSheet.Cells(27, 4) = Round(dvWaterRecord.Item(0)("WaterTon_Empty"), 2)

            'sqlWaterRecord = "SELECT * FROM Cargo_Water WHERE SHIP_ID = '" & Ship_ID & "' AND Flag = '" & Me.C1DBG.Columns("TimeNumEnd").Value & "'"
            'dvWaterRecord = Filldata(sqlWaterRecord)
            'xlSheet.Cells(14, 6) = Round(dvWaterRecord.Item(0)("WaterDensity_True"), 2)
            'xlSheet.Cells(15, 6) = Round(dvWaterRecord.Item(0)("Fc"), 2)
            'xlSheet.Cells(16, 6) = Round(dvWaterRecord.Item(0)("Ac"), 2)
            'xlSheet.Cells(17, 6) = Decimal.Round(dvWaterRecord.Item(0)("Mc"), 2)
            'xlSheet.Cells(18, 6) = Round(dvWaterRecord.Item(0)("DM_WaterDepth"), 2)
            'xlSheet.Cells(19, 6) = Round(dvWaterRecord.Item(0)("WaterTon_Corres"), 2)
            'xlSheet.Cells(20, 6) = Round(dvWaterRecord.Item(0)("WaterTon_Clean_G"), 2)
            'xlSheet.Cells(21, 6) = Round(dvWaterRecord.Item(0)("WaterTon_Density"), 2)

            'xlSheet.Cells(23, 6) = Round(dvWaterRecord.Item(0)("Fuel"), 2)
            'xlSheet.Cells(24, 6) = Round(dvWaterRecord.Item(0)("WaterLight"), 2)
            'xlSheet.Cells(25, 6) = Round(dvWaterRecord.Item(0)("WaterCabin"), 2)
            'xlSheet.Cells(26, 6) = Round(dvWaterRecord.Item(0)("ConstNum"), 2)
            'xlSheet.Cells(27, 6) = Round(dvWaterRecord.Item(0)("WaterTon_Empty"), 2)

            sqlWaterRecord = "SELECT * FROM Cargo_Water WHERE SHIP_ID = '" & Ship_ID & "' AND Flag = '" & Me.C1DBG.Columns("TimeNumStart").Value & "'"
            dvWaterRecord = Filldata(sqlWaterRecord)
            xlSheet.Cells(14, 4) = dvWaterRecord.Item(0)("WaterDensity_True")
            xlSheet.Cells(15, 4) = dvWaterRecord.Item(0)("Fc")
            xlSheet.Cells(16, 4) = dvWaterRecord.Item(0)("Ac")
            xlSheet.Cells(17, 4) = dvWaterRecord.Item(0)("Mc")
            xlSheet.Cells(18, 4) = dvWaterRecord.Item(0)("DM_WaterDepth")
            xlSheet.Cells(19, 4) = dvWaterRecord.Item(0)("WaterTon_Corres")
            xlSheet.Cells(20, 4) = dvWaterRecord.Item(0)("WaterTon_Clean_G")
            xlSheet.Cells(21, 4) = dvWaterRecord.Item(0)("WaterTon_Density")

            xlSheet.Cells(23, 4) = dvWaterRecord.Item(0)("Fuel")
            xlSheet.Cells(24, 4) = dvWaterRecord.Item(0)("WaterLight")
            xlSheet.Cells(25, 4) = dvWaterRecord.Item(0)("WaterCabin")
            xlSheet.Cells(26, 4) = dvWaterRecord.Item(0)("ConstNum")
            xlSheet.Cells(27, 4) = dvWaterRecord.Item(0)("WaterTon_Empty")

            sqlWaterRecord = "SELECT * FROM Cargo_Water WHERE SHIP_ID = '" & Ship_ID & "' AND Flag = '" & Me.C1DBG.Columns("TimeNumEnd").Value & "'"
            dvWaterRecord = Filldata(sqlWaterRecord)
            xlSheet.Cells(14, 6) = dvWaterRecord.Item(0)("WaterDensity_True")
            xlSheet.Cells(15, 6) = dvWaterRecord.Item(0)("Fc")
            xlSheet.Cells(16, 6) = dvWaterRecord.Item(0)("Ac")
            xlSheet.Cells(17, 6) = dvWaterRecord.Item(0)("Mc")
            xlSheet.Cells(18, 6) = dvWaterRecord.Item(0)("DM_WaterDepth")
            xlSheet.Cells(19, 6) = dvWaterRecord.Item(0)("WaterTon_Corres")
            xlSheet.Cells(20, 6) = dvWaterRecord.Item(0)("WaterTon_Clean_G")
            xlSheet.Cells(21, 6) = dvWaterRecord.Item(0)("WaterTon_Density")

            xlSheet.Cells(23, 6) = dvWaterRecord.Item(0)("Fuel")
            xlSheet.Cells(24, 6) = dvWaterRecord.Item(0)("WaterLight")
            xlSheet.Cells(25, 6) = dvWaterRecord.Item(0)("WaterCabin")
            xlSheet.Cells(26, 6) = dvWaterRecord.Item(0)("ConstNum")
            xlSheet.Cells(27, 6) = dvWaterRecord.Item(0)("WaterTon_Empty")

            xlSheet.Cells(31, 4) = Me.C1DBG.Columns("Total_Begin").Value
            xlSheet.Cells(31, 6) = Me.C1DBG.Columns("Total_End").Value
            xlSheet.Cells(32, 4) = Me.C1DBG.Columns("Tons_Long").Value
            xlSheet.Cells(32, 6) = Me.C1DBG.Columns("Tons_Gong").Value

            xlSheet.Cells(34, 7) = Me.C1DBG.Columns("Work_No").Value

            xlSheet.Cells(4, 2) = Me.C1DBG.Columns("Consign_Water").Value
            xlSheet.Cells(4, 4) = Me.C1DBG.Columns("Goods").Value
            xlSheet.Cells(4, 7) = Me.C1DBG.Columns("Amount").Value
            xlSheet.Cells(5, 2) = Me.C1DBG.Columns("Chi_Vessel").Value
            xlSheet.Cells(5, 4) = Me.C1DBG.Columns("Voyage").Value
            xlSheet.Cells(5, 7) = dvNational.Item(0)(0)
            xlSheet.Cells(6, 2) = Me.C1DBG.Columns("LoadPort").Value
            xlSheet.Cells(6, 5) = Me.C1DBG.Columns("UnloadPort").Value
            xlSheet.Cells(7, 2) = CDate(C1DBG.Columns("TimeBegin").Value)
            xlSheet.Cells(7, 5) = CDate(C1DBG.Columns("TimeEnd").Value)
            xlSheet.Cells(10, 7) = C1DBG.Columns("Tons_Gong").Value & " 公吨。"
