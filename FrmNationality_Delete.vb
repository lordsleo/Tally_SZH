...
Public Class FrmNationality_Delete
...
Err:
    ...
    Private Sub btResume_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btResume.Click
        Try
            If MsgBox("你确认要删除吗？", MsgBoxStyle.YesNo, "提示") = MsgBoxResult.Yes Then
                Call OperateHistory(G_DeptName, Now, G_User, "删除", "Code_Nationality", Trim(txtID.Text), "Nationality_ID")

                ds.Tables(0).Rows(0).Delete()
                sqlda.Update(ds)

                Dim updatetxt As String
                updatetxt = "delete from code_nationality where nationality_eng=''" & Trim(txtENG.Text) & "''"
    ...
    Private Sub txtEngliah_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles txtEnglish.KeyPress
