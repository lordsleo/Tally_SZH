...
Public Class FRMCARGO_TALLY_CERTIFICATE
...
#Region " Windows 窗体设计器生成的代码 "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FRMCARGO_TALLY_CERTIFICATE))
        ...
        'ToolBar
        '
        Me.ToolBar.Buttons.AddRange(New System.Windows.Forms.ToolBarButton() {Me.tbbtnSep2, Me.tbbtnPrint, Me.tbbtnExport, Me.tbbtnSep3, Me.tbbtnQuit})
        ...
        Me.Menu = Me.MainMenu
        Me.Name = "FRMCARGO_TALLY_CERTIFICATE"
        Me.Text = "理货业务凭证"
...
#End Region
    ...
    Private Sub FRMCARGO_TALLY_CERTIFICATE_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
...
Err:
    ...
    Private Sub eng()
        ...
        Try
            ...
            xlsheet.Cells(9, 5) = DS_DO.Tables(0).Rows(0)(1)
            xlsheet.Cells(9, 7) = DS_DO.Tables(0).Rows(1)(1) & " tallied on sundays/holidays"
            xlsheet.Cells(10, 7) = DS_DO.Tables(0).Rows(2)(1) & " tallied at nitht shifts"
            xlsheet.Cells(20, 5) = DS_DO.Tables(0).Rows(3)(1)
            xlsheet.Cells(21, 5) = DS_DO.Tables(0).Rows(4)(1)
            xlsheet.Cells(22, 5) = DS_DO.Tables(0).Rows(5)(1)
