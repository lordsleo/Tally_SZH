...
Public Class FrmWorkBegin_Delete
...
#Region " Windows 窗体设计器生成的代码 "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        'btQuit
        '
        Me.btQuit.Location = New System.Drawing.Point(118, 104)
        ...
        'btResume
        '
        Me.btResume.Location = New System.Drawing.Point(50, 104)
        ...
        Me.Name = "FrmWorkBegin_Delete"
        Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen
        Me.Text = "班次及起始时间信息_删除"
    ...
    Private Sub btResume_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btResume.Click
        Try
            If MsgBox("你确认要删除吗？", MsgBoxStyle.YesNo, "提示") = MsgBoxResult.Yes Then
                Call OperateHistory(G_DeptName, Now, G_User, "删除", "Work_Begin", Trim(txtID.Text), "WORK_BEGIN_ID")
