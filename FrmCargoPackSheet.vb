...
Public Class FrmCargoPackSheet
    ...
    Public Shared strCodeDept As String
    Public Shared strBillNo, strDayNight As String
    Public Shared dtWorkDate As Date
    Public Shared strVesselName As String
...
#Region " Windows 窗体设计器生成的代码 "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(FrmCargoPackSheet))
        ...
        Me.mnuCompile.MenuItems.AddRange(New System.Windows.Forms.MenuItem() {Me.mnuAdd, Me.mnuEdit, Me.mnuDelete, Me.mnuReport})
        ...
        'ToolBar
        '
        Me.ToolBar.Buttons.AddRange(New System.Windows.Forms.ToolBarButton() {Me.tbbtnFind, Me.tbbtnQuery, Me.tbbtnSep1, Me.tbbtnAdd, Me.tbbtnEdit, Me.tbbtnDelete, Me.tbbtnReport, Me.tbbtnSep2, Me.tbbtnPrint, Me.tbbtnExport, Me.tbbtnSep3, Me.tbbtnQuit})
        ...
        'tbbtnReport
        '
        Me.tbbtnReport.Text = "日报表"
        Me.tbbtnReport.ToolTipText = "工班日报表"
        '
        'mnuReport
        '
        Me.mnuReport.Index = 3
        Me.mnuReport.Text = "日报表(&R)"
        '
        'FrmCargoPackSheet
        '
...
#End Region
    ...
    Private Sub FrmCargoPackSheet_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub C1DBGV_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles C1DBGV.DoubleClick
        ...
        Call preview("WL3_6_2") '*****************权限设计 '*************要修改模块号
...
Err:
    ...
    Private Sub mnuAdd_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles mnuAdd.Click
        Dim FrmAdd As New FrmCargoPackSheet_Add()     '***********要修改
        If ds.Tables(0).Rows.Count > 0 Then
            ID = CType(Me.C1DBG.Columns.Item("ID").Text.ToString, Integer)
        Else
            ID = -1
    ...
    Private Sub mnuReport_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles mnuReport.Click
        If ds.Tables(0).Rows.Count > 0 Then
            Dim FrmReport As New FrmCargoPackSheet_Report
            strBillNo = Me.C1DBG.Columns("BLNO").Text
            strDayNight = Me.C1DBG.Columns("DayOrNight").Text
            dtWorkDate = Me.C1DBG.Columns("WorkDate").Value
            strVesselName = Me.C1DBG.Columns("CHI_VESSEL").Text
