...
Public Class FrmCargoPackRecord_Delete
...
#Region " Windows 窗体设计器生成的代码 "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.btQuit.Location = New System.Drawing.Point(206, 254)
        ...
        'btSave
        '
        Me.btSave.Location = New System.Drawing.Point(138, 254)
        Me.btSave.Name = "btSave"
        Me.btSave.Size = New System.Drawing.Size(65, 24)
        Me.btSave.TabIndex = 445
        Me.btSave.Text = "确认"
        '
        'cbGoodsCode
        '
        ...
        Me.Name = "FrmCargoPackRecord_Delete"
        Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen
        Me.Text = "散货灌包交接单信息 删除"
...
#End Region
    ...
    Private Sub FrmCargoPackRecord_Delete_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Try
            ...
            cbBillNo.Enabled = False
            cbGoodsCode.Enabled = False
    ...
    Private Sub btSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btSave.Click
        Try
            If MessageBox.Show("确认要删除吗？", "警告提示", MessageBoxButtons.OKCancel, MessageBoxIcon.Asterisk, MessageBoxDefaultButton.Button2) = DialogResult.OK Then
                '记录操作日志
                Call OperateHistory(G_DeptName, Now, G_User, "删除", "CARGO_PACK_RECORD", Trim(txtID.Text), "CARGO_PACK_ID")
