...
Public Class FrmGoodsYardInfo_Edit
...
#Region " Windows 窗体设计器生成的代码 "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.txtBargainNO.TabIndex = 392
        Me.txtBargainNO.Text = ""
        '
        'btQuit
        '
        Me.btQuit.DialogResult = System.Windows.Forms.DialogResult.Cancel
        Me.btQuit.Location = New System.Drawing.Point(216, 224)
        Me.btQuit.Name = "btQuit"
        Me.btQuit.Size = New System.Drawing.Size(65, 24)
        Me.btQuit.TabIndex = 412
        Me.btQuit.Text = "取消"
        '
        'btSave
        '
        Me.btSave.Location = New System.Drawing.Point(148, 224)
        Me.btSave.Name = "btSave"
        Me.btSave.Size = New System.Drawing.Size(65, 24)
        Me.btSave.TabIndex = 411
        Me.btSave.Text = "确认"
        '
        'cbConMark
        '
        ...
        Me.txtTotalWeight.TabIndex = 391
...
#End Region
    ...
    Private Sub FrmGoodsYardInfo_Edit_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        On Error GoTo Err
            ...
            If Trim(txtShip.Text) <> "" And Trim(txtVoyage.Text) <> "" And Trim(txtBillNO.Text) <> "" And Me.cbClient.SelectedValue <> "00" Then
                ...
                If Trim(txtTotalWeight.Text) <> "" Then
                    If IsNumeric(Trim(txtTotalWeight.Text)) Then
                        ds.Tables(0).Rows(0).Item("TOTAL_WEIGHT") = Trim(txtTotalWeight.Text)
                    Else
                ...
                If Trim(txtSize.Text) <> "" Then
                    If IsNumeric(Trim(txtSize.Text)) Then
                        ds.Tables(0).Rows(0).Item("SIZE_MEASURE") = Trim(txtSize.Text)
                    Else
                ...
                sqlExist = "select * from CON_LOAD_LIST where CONTRACT_NO = '" & Trim(txtBargainNO.Text) & _
                        ...
                        "' and VOYAGE = '" & Trim(txtVoyage.Text) & "' and CON_LOAD_LIST_ID <> '" & ID & "'"
                If Filldata(sqlExist).Count = 0 Then
                    ...
                    ds.Tables(0).Rows(0).Item("BLNO") = Trim(txtBillNO.Text)
                    ds.Tables(0).Rows(0).Item("MARK") = Trim(txtMark.Text)
                    ds.Tables(0).Rows(0).Item("Goods_Cha") = Trim(txtDescCha.Text)
                    ds.Tables(0).Rows(0).Item("Goods_Eng") = Trim(txtDescEng.Text)
                    ...
                    ds.Tables(0).Rows(0).Item("CONTAINER_MARK") = cbConMark.SelectedValue
                    ds.Tables(0).Rows(0).Item("CODE_PACK") = cbPack.SelectedValue
                    ds.Tables(0).Rows(0).Item("CLIENT") = cbClient.SelectedValue
                    ...
                    If MessageBox.Show("确认要修改吗？", "警告提示", MessageBoxButtons.OKCancel, MessageBoxIcon.Asterisk, MessageBoxDefaultButton.Button2) = DialogResult.OK Then
                        Call OperateHistory(G_DeptName, Now, G_User, "修改", "CON_LOAD_LIST", Trim(txtID.Text), "CON_LOAD_LIST_ID")
                        sqlda.Update(ds)
                        Me.Close()
                    End If
                Else
