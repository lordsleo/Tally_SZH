...
Public Class FrmCargoWater_Add
...
#Region " Windows 窗体设计器生成的代码 "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.lbT_WaterOdds.TabIndex = 477
        Me.lbT_WaterOdds.TextAlign = System.Drawing.ContentAlignment.MiddleRight
        '
        'btnFiqure
        '
        Me.btnFiqure.Location = New System.Drawing.Point(34, 402)
        Me.btnFiqure.Name = "btnFiqure"
        Me.btnFiqure.Size = New System.Drawing.Size(65, 24)
        Me.btnFiqure.TabIndex = 29
        Me.btnFiqure.Text = "计算结果"
        '
        'btQuit
        '
        Me.btQuit.DialogResult = System.Windows.Forms.DialogResult.Cancel
        Me.btQuit.Location = New System.Drawing.Point(348, 410)
        Me.btQuit.Name = "btQuit"
        Me.btQuit.Size = New System.Drawing.Size(65, 24)
        Me.btQuit.TabIndex = 31
        Me.btQuit.Text = "取消"
        '
        'btSave
        '
        Me.btSave.Location = New System.Drawing.Point(280, 410)
        ...
        'btAdd
        '
        Me.btAdd.Location = New System.Drawing.Point(212, 410)
        Me.btAdd.Name = "btAdd"
        ...
        Me.lbCargoWeight_ConstNum.TabIndex = 467
        ...
        Me.txtConstNum_Empty.TabIndex = 21
        ...
        Me.txtWaterTon_Empty.TabIndex = 20
        ...
        Me.txtWaterDensity_Draw.TabIndex = 15
        ...
        Me.lbWaterTon_Clean_Y.TabIndex = 432
        ...
        Me.Label8.Location = New System.Drawing.Point(220, 4)
        ...
        Me.lbSubtotalThing.TabIndex = 376
        ...
        Me.txtAverageWater.TabIndex = 14
        ...
        Me.lbDM_WaterDepth.TabIndex = 417
        ...
        Me.lbWaterTon_Density.TabIndex = 411
        ...
        Me.lbWaterTon_Clean_G.TabIndex = 415
        ...
        Me.txtWaterDensity_True.TabIndex = 16
        ...
        Me.lbWaterTon_Odds.TabIndex = 479
        ...
        Me.txtConsign.TabIndex = 22
        Me.txtConsign.Text = ""
        '
        'Label34
        '
        Me.Label34.Location = New System.Drawing.Point(394, 372)
        Me.Label34.Name = "Label34"
        Me.Label34.Size = New System.Drawing.Size(104, 20)
        Me.Label34.TabIndex = 481
        Me.Label34.Text = "船长/大副/委托方"
        ...
        Me.lbDM_WaterDep_Corres.TabIndex = 489
        ...
        Me.lbWaterTon_Corres.TabIndex = 491
        Me.lbWaterTon_Corres.TextAlign = System.Drawing.ContentAlignment.MiddleRight
        '
        'Label32
        '
        Me.Label32.Location = New System.Drawing.Point(454, 6)
        ...
        Me.ClientSize = New System.Drawing.Size(598, 439)
...
#End Region
    ...
    Private Sub FrmCargoWater_Add_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If dw.Count > 0 Then
            ...
            Me.txtFuel.Text = ds.Tables(0).Rows(0).Item("Fuel")
            ...
            End If
        End If
        sqlTime = "select max(flag) as Flag , ship_id from CARGO_WATER group by SHIP_ID having SHIP_ID = '" & Ship_ID & "'"
        dvTime = Filldata(sqlTime)
        ...
        Try
            If Trim(txtWorker.Text) <> "" Then
                ...
                If Me.lbCargoWeight_ConstNum.Text = "" Then
                    If MessageBox.Show("此水尺记录结果未能算出，仍要增加当前记录吗？", "信息提示", MessageBoxButtons.OKCancel, MessageBoxIcon.Information, MessageBoxDefaultButton.Button2) = DialogResult.Cancel Then
                        Exit Sub
                    End If
                Else
                    If CDec(lbCargoWeight_ConstNum.Text) <= 0.0 And frmJudge.markShip = True Then '是重船 但货重非正数　不正常
                        If MessageBox.Show("重船货重非正数，结果不正常，可能输入数据或判断有误。仍要增加当前记录吗？", "信息提示", MessageBoxButtons.OKCancel, MessageBoxIcon.Information, MessageBoxDefaultButton.Button2) = DialogResult.Cancel Then
                            Exit Sub
                        End If
                    End If
                End If

                If FrmCargoWater.C1Count >= 10 Then
                    If MessageBox.Show("该船次水尺记录已有十次以上，仍要增加当前记录吗？", "信息提示", MessageBoxButtons.OKCancel, MessageBoxIcon.Information) = DialogResult.Cancel Then
                        Exit Sub
                    End If
                End If

                If dvTime.Count = 1 Then
                    iCount = dvTime.Item(0)(0)
                ElseIf dvTime.Count = 0 Then
                    iCount = 0          '第一次
                Else
                    MessageBox.Show("意外事故。", "错误提示", MessageBoxButtons.OK, MessageBoxIcon.Error)
                    Exit Sub
                End If
                row.Item("Flag") = iCount + 1   '标记次数
...
JumpHere:   End If
    ...
    Private Sub btAdd_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btAdd.Click
        ...
        If Not iTime = 0 Then
            Me.Label8.Text = "本次新增第 " & dvTime.Item(0)(0) + 1 & " 次测试记录"
            Me.Label32.Text = "前次水尺记录是第 " & dvTime.Item(0)(0) & " 次"
        End If
