...
Public Class FrmCargoPackRecord_Add
...
#Region " Windows 窗体设计器生成的代码 "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.btQuit.Location = New System.Drawing.Point(236, 254)
        ...
        'btSave
        '
        Me.btSave.Location = New System.Drawing.Point(168, 254)
        ...
        'btnClear
        '
        Me.btnClear.Location = New System.Drawing.Point(100, 254)
        ...
        Me.txtTestAmount_M.TabIndex = 10
        ...
        Me.txtEligibleAmount.TabIndex = 15
        ...
        Me.txtDiseligibleAmount.TabIndex = 16
        ...
        Me.txtAverageWeight.TabIndex = 12
        ...
        Me.txtEligibleRate.TabIndex = 17
...
#End Region
    ...
    Private Sub FrmCargoPackRecord_Add_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub btSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btSave.Click
        ...
        sqlExist = "select * from CARGO_PACK_RECORD where SHIP_ID = '" & Ship_ID & _
                ...
                "' and CODE_COMPANY = '" & cbCompany.SelectedValue & "'"
        Try
            ...
            If DateDiff(DateInterval.Minute, dtpTimeBegin.Value, dtpTimeEnd.Value) > 0 Then
                ...
                row.Item("COMMISSURE_QUALITY") = Trim(txtSeem.Text)

                row.Item("BLNO") = cbBillNo.SelectedValue
                row.Item("CODE_GOODS") = cbGoodsCode.SelectedValue
                row.Item("CODE_COMPANY") = cbCompany.SelectedValue

                row.Item("DEPT_CODE") = FrmCargoPackRecord.strCodeDept
    ...
    Private Sub btnClear_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnClear.Click
        Me.txtPackAmount_M.Clear()
        Me.txtPackAmount_P.Clear()
        Me.txtPackWeight_M.Clear()
        Me.txtPackWeight_P.Clear()
        Me.txtTestAmount_M.Clear()
        Me.txtTestAmount_P.Clear()

        Me.txtStandWeight.Clear()
        Me.txtAverageWeight.Clear()
        Me.txtMostWeight.Clear()
        Me.txtLeastWeight.Clear()
        Me.txtEligibleAmount.Clear()
        Me.txtDiseligibleAmount.Clear()
    ...
    Private Sub cbBillNo_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cbBillNo.SelectedIndexChanged
        Try
            If TypeName(cbBillNo.SelectedValue) = "String" Then
                ...
                'sqlCompany = "SELECT DISTINCT CompCode, DepartMent FROM View_CargoGoodsPub WHERE SHIP_ID = '" & Ship_ID & "' and BLNO = '" & cbBillNo.SelectedValue & "'"
                dwCodeGoods = Filldata(sqlCodeGoods)
                'dwCompany = Filldata(sqlCompany)
