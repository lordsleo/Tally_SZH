...
Public Class FrmREPORT_TALLY_QUALITY
...
#Region " Windows 窗体设计器生成的代码 "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(FrmREPORT_TALLY_QUALITY))
        ...
        Me.Menu = Me.MainMenu
        Me.Name = "FrmREPORT_TALLY_QUALITY"
        Me.Text = "理货质量统计月报"
...
#End Region
    ...
    Private Sub myDataGrid(ByVal SelStr As String, ByVal Sql As String)
        ...
        Dim i As Integer
        Try
            strsql = "select " & SelStr & " * from VIEW_REPORT_TALLY_QUALITY where " & Sql '******要修改
            Me.C1DBG.DataSource = Getdata(strsql, ds)
            ColNum = 2 '不显示的列数 '******要修改
            Table_Name = "VIEW_REPORT_TALLY_QUALITY" '操作的数据库表名 ''******要修改
            For i = 0 To ColNum - 1
                Me.C1DBG.Splits(0).DisplayColumns.Item(i).Visible = False
            Next
            Me.C1DBG.Columns.Item("YEARMONTH").NumberFormat = "yyyy年 MM月"
            Me.C1DBG.Columns.Item("ITEMC").NumberFormat = "P"
            Me.C1DBG.Columns.Item("ITEMF").NumberFormat = "P"
            Me.C1DBG.Columns.Item("ITEMI").NumberFormat = "P"
            Me.C1DBG.Columns.Item("ITEML").NumberFormat = "P"
...
Err:
    ...
    Private Sub mnuDelete_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles mnuDelete.Click
        If ds.Tables(0).Rows.Count > 0 Then
            Dim FrmDelete As New FrmREPORT_TALLY_QUALITY_Delete() '***********要修改
    ...
    Private Sub mnuEdit_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles mnuEdit.Click
        If ds.Tables(0).Rows.Count > 0 Then
            Dim FrmEdit As New FrmREPORT_TALLY_QUALITY_Edit() '***********要修改
    ...
    Private Sub mnuAdd_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles mnuAdd.Click
        ...
        Dim FrmAdd As New FrmREPORT_TALLY_QUALITY_ADD()  '***********要修改
        FrmAdd.ShowDialog()
        Try
            Call myDataGrid(SelectStr, SqlStr)
        Catch ex As Exception
    ...
    Private Sub mnuPrint_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles mnuPrint.Click
        ...
        Dim FrmPrint As New FrmREPORT_TALLY_QUALITY_Print()
        FrmPrint.ShowDialog()
        Try
    ...
    Private Sub MakeExcel()
        ...
        Dim ds_sp As New DataSet()
        Try
            Getdata("exec sp_REPORT_TALLY_QUALITY '" & GL_Date & "'", ds_sp)
            ...
            xlSheet = CType(xlBook.Worksheets("质量"), Excel.Worksheet)
            ...
            For Row = 0 To ds.Tables(0).Rows.Count - 1 '数据
                ...
                For Col = ColNum + 2 To Me.C1DBG.Columns.Count - 1
                    xlSheet.Cells(row_id + 5, Col - ColNum + 1) = Me.C1DBG.Columns(Col).Text.ToString  'ds.Tables(0).Rows(Row)(Col)
                Next Col
                Me.C1DBG.MoveNext()
            Next Row

            For Row = 0 To ds_sp.Tables(0).Rows.Count - 1 '统计数据
                For Col = 3 To ds_sp.Tables(0).Columns.Count - 1
                    xlSheet.Cells(Row + 8, Col) = ds_sp.Tables(0).Rows(Row)(Col)
                Next Col
            Next Row
