...
#Region " Windows 窗体设计器生成的代码 "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(FrmABSENT_Print))
        ...
        Me.tbbtnFind.Text = "加班"
        Me.tbbtnFind.ToolTipText = "加班信息修改"
        '
        'tbbtnQuery
        '
...
#End Region
    ...
    '*********8.2 '***************要修改
    Private Sub FrmABSENT_Print_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Me.WindowState = FormWindowState.Maximized
        Call preview("WL8_2") '*****************权限设计 '*************要修改模块号
        ...
        FirmStr = "  and  DEPT_CODE= '" & G_DeptCode & "' Order by work_type,WORK_NO,ABSENT_month desc "  '设计初始条件  在检索后不改变的条件 
        DynaStr = " datediff(MM,ABSENT_month,GETDATE())=1 "  '设计其它初始条件    在检索后不需要的条件 ***************要修改 或 其它条件
        SelectStr = " Top 100 "
        SqlStr = " (" & DynaStr & ")  " & FirmStr

        Dim sql_fi As String
        sql_fi = ""
        If G_DeptCode = "26.13" Then
            sql_fi = " (WORK_NO= '020880' and datediff(MM,ABSENT_month,GETDATE())=1)  "
        End If
        'If G_DeptCode = "26.14" Then
        '    sql_fi = " (WORK_NO= '020791' and datediff(MM,ABSENT_month,GETDATE())=1)  "
        'End If
        If G_DeptCode = "26.16" Then
            sql_fi = " (WORK_NO= '012281' and datediff(MM,ABSENT_month,GETDATE())=1)  "
        End If
        If G_DeptCode = "26.11" Then
            sql_fi = " (WORK_NO= '166066' and datediff(MM,ABSENT_month,GETDATE())=1)  " 'datediff(MM,ABSENT_month,'" & GL_Date & "')=0)  "
        End If
        If Len(Trim(sql_fi)) > 0 Then
            SqlStr = sql_fi + " or " + SqlStr
        End If
    ...
    Private Sub myDataGrid(ByVal SelStr As String, ByVal Sql As String)
        ...
        Dim i As Integer
        Try
            strsql = "select " & SelStr & " * from VIEW_ABSENT_history where " & Sql '******要修改
            GL_Shift = Sql
...
Err:
    ...
    Private Sub mnuDelete_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles mnuDelete.Click
        If ds.Tables(0).Rows.Count > 0 Then
            Dim FrmDelete As New FrmABSENT_Print_Delete   '***********要修改
    ...
    Private Sub mnuEdit_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles mnuEdit.Click
        If ds.Tables(0).Rows.Count > 0 Then
            Dim FrmEdit As New FrmABSENT_Print_Edit   '***********要修改
    ...
    Private Sub mnuAdd_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles mnuAdd.Click
        Dim sql_fi As String
        Dim FrmPrint As New FrmABSENT_Print_Dialog
        FrmPrint.ShowDialog()
        Try
            sql_fi = ""
            If G_DeptCode = "26.13" Then
                sql_fi = " (WORK_NO= '020880' and datediff(MM,ABSENT_month,'" & GL_Date & "')=0)  "
            End If
            If G_DeptCode = "26.14" Then
                sql_fi = " (WORK_NO= '020791' and datediff(MM,ABSENT_month,'" & GL_Date & "')=0)  "
            End If
            If G_DeptCode = "26.16" Then
                sql_fi = " (WORK_NO= '012281' and datediff(MM,ABSENT_month,'" & GL_Date & "')=0)  "
            End If
            If G_DeptCode = "26.11" Then
                sql_fi = " (WORK_NO= '166066' and datediff(MM,ABSENT_month,'" & GL_Date & "')=0)  "
            End If
    ...
    Private Sub PrintExcel()
        ...
        Try
            ...
            FileCopy(PathStr + "考勤表.xls", PathStr + "Report.xls")
            ...
            xlSheet = CType(xlBook.Worksheets("考勤表"), Excel.Worksheet)
            ...
            If Len(Trim(GL_Str)) <> 0 Then
                ...
                End If
            End If
            xlSheet.Cells(2, 1) = " 部门： " & G_DeptName & str
            xlSheet.Cells(3, 3) = Year(Me.C1DBG.Columns(6).Value) & " 年 " & Month(Me.C1DBG.Columns(6).Value) & " 月"
            xlSheet.Cells(2, 39) = "填报日期：" & Year(Now) & " 年" & Month(Now) & " 月" & Day(Now) & " 日"
