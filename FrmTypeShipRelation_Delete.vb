...
Public Class FrmTypeShipRelation_Delete
...
#Region " Windows 窗体设计器生成的代码 "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        'btQuit
        '
        Me.btQuit.Location = New System.Drawing.Point(118, 94)
        ...
        'btSave
        '
        Me.btSave.Location = New System.Drawing.Point(50, 94)
        ...
        Me.Name = "FrmTypeShipRelation_Delete"
        Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen
        Me.Text = "箱号与船公司箱型对照表_删除"
    ...
    Private Sub btSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btSave.Click
        Try
            If MsgBox("你确认要删除吗？", MsgBoxStyle.YesNo, "提示") = MsgBoxResult.Yes Then
                Call OperateHistory(G_DeptName, Now, G_User, "删除", "CODE_TYPE_SHIP_RELATION", Trim(txtID.Text), "CODE_TYPE_SHIP_RELATION_ID")
