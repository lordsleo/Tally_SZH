...
#Region " Windows 窗体设计器生成的代码 "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(Frmport_unload))
        ...
        Me.Label.Name = "Label"
        Me.Label.Size = New System.Drawing.Size(530, 30)
        ...
        Me.ToolBar.Size = New System.Drawing.Size(534, 38)
...
#End Region
    ...
    Private Sub Frmport_unload_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub myDataGrid(ByVal SelStr As String, ByVal Sql As String)
        ...
        Try
            If mark = "1" Then
                ...
                Me.C1DBG.Columns.Item("amount").Caption = "件数包装"
                Me.C1DBG.Columns.Item("tally_amount").Caption = "件数和包装"
...
Err:
            ...
            Case 0
                Try
                    ...
                    If ds_sship.Tables(0).Rows.Count > 0 Then
                        ...
                        If trade = "1" Then
                            dw = Getdata("exec SP_UNLOAD '" & Ship_ID & "'", DS_DO)
                            mark = "1"


                        ElseIf trade = "2" Then
                            dw = Getdata("exec SP_UNLOAD_eng '" & Ship_ID & "'", DS_DO)
                            mark = "1"
    ...
    Private Sub china()
        ...
        Try
            ...
            xlsheet = CType(xlbook.Worksheets("分港卸货单"), Excel.Worksheet)
            ...
            xlsheet.Cells(3, 4) = "泊位： " & DS_DO.Tables(1).Rows(0).Item("berth")
            ...
            For row = 0 To DS_DO.Tables(0).Rows.Count - 1
                For col = 0 To 4
                    xlsheet.Cells(10 + row, col + 1) = DS_DO.Tables(0).Rows(row)(col)
                Next col
            Next row
    ...
    Private Sub eng()
        ...
        Try
            ...
            xlapp = CType(CreateObject("excel.application"), Excel.Application)
            xlbook = CType(xlapp.Workbooks.Open("" & Filepath & ""), Excel.Workbook)
            xlsheet = CType(xlbook.Worksheets("分港卸货单英文版"), Excel.Worksheet)
            xlapp.DisplayAlerts = False
            xlsheet.Application.Visible = True
            ...
            xlsheet.Cells(3, 4) = "Berth: " & DS_DO.Tables(1).Rows(0).Item("berth")
