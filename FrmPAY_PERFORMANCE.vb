...
Public Class FrmPAY_PERFORMANCE
...
#Region " Windows 窗体设计器生成的代码 "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(FrmPAY_PERFORMANCE))
...
#End Region
    ...
    '*********8.3 '***************要修改
    Private Sub FrmPAY_PERFORMANCE_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Me.WindowState = FormWindowState.Maximized
        Call preview("WL8_3") '*****************权限设计 '*************要修改模块号
    ...
    Private Sub myDataGrid(ByVal SelStr As String, ByVal Sql As String)
        ...
        Dim i As Integer
        Try
            strsql = "select " & SelStr & " * from VIEW_PAY_PERFORMANCE where " & Sql
            Me.C1DBG.DataSource = Getdata(strsql, ds)
            ColNum = 3
            Table_Name = "VIEW_PAY_PERFORMANCE"

            For i = 0 To ColNum - 1
                Me.C1DBG.Splits(0).DisplayColumns.Item(i).Visible = False
            Next
            Me.C1DBG.Columns.Item("YearMonth").NumberFormat = "yyyy-MM"
            For i = 8 To 14
...
Err:
    ...
    Private Sub mnuAdd_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles mnuAdd.Click
        Dim FrmAdd As New FrmPAY_PERFORMANCE_Dialog() '***********要修改
