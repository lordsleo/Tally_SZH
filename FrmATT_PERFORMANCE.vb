...
Public Class FrmATT_PERFORMANCE
...
#Region " Windows 窗体设计器生成的代码 "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(FrmATT_PERFORMANCE))
...
#End Region
    ...
    '*********8.4 '***************要修改
    Private Sub FrmATT_PERFORMANCE_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Me.WindowState = FormWindowState.Maximized
        Call preview("WL8_4") '*****************权限设计 '*************要修改模块号
        Me.Text = Me.Text & "_" & G_DeptName
        FirmStr = " Order by work_type,WORK_NO,YearMonth desc "  '设计初始条件  在检索后不改变的条件 
...
Err:
    ...
    Private Sub mnuAdd_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles mnuAdd.Click
        Dim FrmAdd As New FrmATT_PERFORMANCE_Dialog() '***********要修改
