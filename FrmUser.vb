...
#Region " Windows 窗体设计器生成的代码 "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.ToolBar.Size = New System.Drawing.Size(544, 38)
        ...
        Me.C1DBG.Size = New System.Drawing.Size(544, 315)
        Me.C1DBG.TabIndex = 8
...
#End Region
    ...
    Private Sub FrmBoiler_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Me.WindowState = FormWindowState.Maximized
        preview("WL11_2")
        Me.Text = Me.Text & "_" & G_DeptName
        FirmStr = " Dept_Code Like '" & Trim(G_DeptCode) & "%'   Order by ID"

        '设计初始条件  在检索后不改变的条件  '***************要修改 或 2>1
    ...
    Private Sub myDataGrid(ByVal Sql As String)
        ...
        Try
            '不显示的列名在最前面
            strsql = "select * from View_User where " & Sql & ""
            Me.C1DBG.DataSource = Getdata(strsql, ds)  ' class dbcontrol getdata fuction

            ColNum = 3 '不显示的列数 '******要修改
            Table_Name = "View_User" '操作的数据库表名 ''******要修改
...
Err:
    ...
    End Sub
    Private Sub FrmBoiler_Closed(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Closed
        TBar = 1
        Mnu = 1
    End Sub
    ...
    Private Sub mnuFind_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles mnuFind.Click
        ...
        If Flag = 0 Then
            SelectStr = ""
            Call myDataGrid(" (" & Sql_Find & ")  and " & FirmStr)   '可能要修改
            SqlStr = " (" & Sql_Find & ")  and  " & FirmStr '可能要修改
        ElseIf Flag = 2 Then
            SelectStr = ""
            Call myDataGrid(DynaStr & " and " & FirmStr) '可能要修改
            SqlStr = DynaStr & " and " & FirmStr '可能要修改
        End If
    End Sub
End Class
