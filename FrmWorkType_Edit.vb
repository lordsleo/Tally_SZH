...
#Region " Windows 窗体设计器生成的代码 "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        'btQuit
        '
        Me.btQuit.Location = New System.Drawing.Point(130, 74)
        ...
        'btResume
        '
        Me.btResume.Location = New System.Drawing.Point(62, 74)
    ...
    Private Sub btResume_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btResume.Click
        Try
            If MsgBox("你确认要修改吗？", MsgBoxStyle.YesNo, "提示") = MsgBoxResult.Yes Then
                Call OperateHistory(G_DeptName, Now, G_User, "修改", "Code_WorkTYPE", Trim(txtID.Text), "WorkTYPE_ID")

                ds.Tables(0).Rows(0).Item("code_WorkTYPE") = Trim(txtCode.Text)
                ds.Tables(0).Rows(0).Item("WorkTYPE") = Trim(txtWorkType.Text)
