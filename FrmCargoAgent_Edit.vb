...
Public Class FrmCargoAgent_Edit
...
#Region " Windows 窗体设计器生成的代码 "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        'btQuit
        '
        Me.btQuit.Location = New System.Drawing.Point(242, 178)
        ...
        'btResume
        '
        Me.btResume.Location = New System.Drawing.Point(174, 178)
        Me.btResume.Name = "btResume"
        Me.btResume.Size = New System.Drawing.Size(65, 24)
        Me.btResume.TabIndex = 157
        Me.btResume.Text = "确认"
        '
        'txtTelephone
        '
    ...
    Private Sub btResume_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btResume.Click
        Try
            If MsgBox("你确认要修改吗？", MsgBoxStyle.YesNo, "提示") = MsgBoxResult.Yes Then
                Call OperateHistory(G_DeptName, Now, G_User, "修改", "Code_Cargo_Agent", Trim(txtID.Text), "Cargo_Agent_ID")

                ds.Tables(0).Rows(0).Item("CODE_Cargo_AGENT") = Trim(txtCode.Text)
                ds.Tables(0).Rows(0).Item("CargoAGENT_CHA") = Trim(txtCHA.Text)
                ds.Tables(0).Rows(0).Item("CargoAGENT_ENG") = Trim(txtENG.Text)
                ...
                ds.Tables(0).Rows(0).Item("CARGOAGENT_SHORT") = Trim(txtShort.Text)
                sqlda.Update(ds)
                Me.Close()
