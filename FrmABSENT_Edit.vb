...
#Region " Windows 窗体设计器生成的代码 "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        'btQuit
        '
        Me.btQuit.Location = New System.Drawing.Point(94, 88)
        ...
        'btResume
        '
        Me.btResume.Location = New System.Drawing.Point(26, 88)
...
#End Region
    ...
    Private Sub FrmABSENT_Edit_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
...
Err:
    ...
    Private Sub btResume_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btResume.Click
        Try
            If MsgBox("你确认要修改吗？", MsgBoxStyle.YesNo, "提示") = MsgBoxResult.Yes Then
                ...
                Call OperateHistory(G_DeptName, Now, G_User, "修改", "ABSENT", Trim(txtID.Text), "ABSENT_ID")
                ds.Tables(0).Rows(0).Item("Code_HOLIDAY_TYPE") = CmbCode_HOLIDAY_TYPE.SelectedValue
                ds.Tables(0).Rows(0).Item("ABSENTDATE") = DTPABSENTDATE.Value
    ...
    Private Sub TxtWORK_NAME_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles TxtWORK_NAME.KeyDown
