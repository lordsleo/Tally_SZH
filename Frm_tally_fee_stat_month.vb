...
Public Class Frm_tally_fee_stat_month
...
#Region " Windows 窗体设计器生成的代码 "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(Frm_tally_fee_stat_month))
        ...
        Me.Name = "Frm_tally_fee_stat_month"
...
#End Region
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_enter.Click
        Me.c1dbg.DataSource = Getdata("sp_tally_fee_stat_month  '" & Me.dt_month.Value & "'", ds)
        caption()
        columnswidth()
    End Sub
    ...
    Private Sub caption()
        ...
        Me.c1dbg.Columns("pay_item").Caption = "收费项目"
        Me.c1dbg.Columns("cargo_board_ship").Caption = "国际件杂货_外轮"
        Me.c1dbg.Columns("cargo_cosco").Caption = "国际件杂货_中远"
        Me.c1dbg.Columns("cargo_other").Caption = "国际件杂货_其他"
        Me.c1dbg.Columns("cargo_sum").Caption = "国际件杂货_小计"
        Me.c1dbg.Columns("con_board_ship").Caption = "国际集装箱_外轮"
        Me.c1dbg.Columns("con_cosco").Caption = "国际集装箱_中远"
        Me.c1dbg.Columns("con_other").Caption = "国际集装箱_其他"
        Me.c1dbg.Columns("con_sum").Caption = "国际集装箱_小计"
        Me.c1dbg.Columns("load_china_ocean").Caption = "国内船舶_中海"
        Me.c1dbg.Columns("load_other").Caption = "国内船舶_其他"
        Me.c1dbg.Columns("load_sum").Caption = "国内船舶_小计"
        Me.c1dbg.Columns("month_total_sum").Caption = "合计"
        Me.c1dbg.Columns("year_total_sum").Caption = "自年初累计"
    End Sub
    ...
    Private Sub MakeExcel()
        ...
        Try
            ...
            xlSheet = CType(xlBook.Worksheets("tally_fee_stat_month"), Excel.Worksheet)
            xlApp.DisplayAlerts = False
            xlSheet.Application.Visible = True
            xlBook.Worksheets("tally_fee_stat_month").select()
            Me.c1dbg.MoveFirst()
            For Row = 0 To ds.Tables(0).Rows.Count - 1 '数据
                For Col = 4 To Me.c1dbg.Columns.Count - 1
                    xlSheet.Cells(Row + 6, Col) = Me.c1dbg.Columns(Col).Text.ToString       'ds.Tables(0).Rows(Row)(Col)
                Next Col
                Me.c1dbg.MoveNext()
            Next Row
        Catch
