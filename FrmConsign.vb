...
#Region " Windows 窗体设计器生成的代码 "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(FrmConsign))
        ...
        Me.GBV.Name = "GBV"
        Me.GBV.Size = New System.Drawing.Size(174, 379)
        Me.GBV.TabIndex = 0
        ...
        Me.btResure.Location = New System.Drawing.Point(126, 315)
        ...
        Me.txtVoyage.Anchor = ((System.Windows.Forms.AnchorStyles.Bottom Or System.Windows.Forms.AnchorStyles.Left) _
                    Or System.Windows.Forms.AnchorStyles.Right)
        Me.txtVoyage.Location = New System.Drawing.Point(36, 315)
        ...
        Me.txtShipName.Anchor = ((System.Windows.Forms.AnchorStyles.Bottom Or System.Windows.Forms.AnchorStyles.Left) _
                    Or System.Windows.Forms.AnchorStyles.Right)
        Me.txtShipName.Location = New System.Drawing.Point(36, 291)
        ...
        Me.ToolBarV.Location = New System.Drawing.Point(3, 338)
        Me.ToolBarV.Name = "ToolBarV"
        Me.ToolBarV.ShowToolTips = True
        Me.ToolBarV.Size = New System.Drawing.Size(168, 38)
        Me.ToolBarV.TabIndex = 0
        '
        'S1
        '
        ...
        Me.C1DBGV.Size = New System.Drawing.Size(168, 247)
        Me.C1DBGV.TabIndex = 1
        ...
        ", 0, 164, 243</ClientRect><BorderSide>0</BorderSide><CaptionStyle parent=""Style2" & _
        ...
        Me.GB.Name = "GB"
        Me.GB.Size = New System.Drawing.Size(538, 379)
        Me.GB.TabIndex = 1
        Me.GB.TabStop = False
        '
        'Label
        ...
        Me.Label.Location = New System.Drawing.Point(4, 58)
        Me.Label.Name = "Label"
        ...
        Me.ToolBar.Size = New System.Drawing.Size(532, 38)
...
#End Region
    ...
    Private Sub Frm_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Call preview("WL2_3") '*****************权限设计 '*************要修改模块号
        Me.Text = Me.Text & "_" & G_DeptName

        SortShip = " Order by Ship_Statu,Dept_Code,id desc " '默认的排序 
        FirmShip = "where DEPT_CODE LIKE '" & G_DeptCode & "%'" '船舶不变的条件设计
        SqlStrShip = "where (DEPT_CODE LIKE '" & G_DeptCode & "%' and SHIP_STATU in ('1','2','3') and code_goods<>'2') OR (Ship_Statu in ('1') and len(ltrim(BerthNo))=0) "
    ...
    Private Sub SetColumnWidthShip() '************航次列宽
        Try
            Me.C1DBGV.Splits(0).DisplayColumns.Item(4).Width = 54
            Me.C1DBGV.Splits(0).DisplayColumns.Item(5).Width = 54
            Me.C1DBGV.Splits(0).DisplayColumns.Item(6).Width = 42
            Me.C1DBGV.Splits(0).DisplayColumns.Item(7).Width = 30
    ...
    Private Sub C1DBGV_FetchRowStyle(ByVal sender As Object, ByVal e As C1.Win.C1TrueDBGrid.FetchRowStyleEventArgs) Handles C1DBGV.FetchRowStyle
        ...
        End If
        If Me.C1DBGV.Columns("SHIP_STATU").CellValue(e.Row) = 3 Then
            e.CellStyle.BackColor = System.Drawing.Color.LemonChiffon
        End If
        If Me.C1DBGV.Columns("SHIP_STATU").CellValue(e.Row) = 4 Then
    ...
    Private Sub C1DBGV_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles C1DBGV.DoubleClick
        ...
        strsql = "select * from View_SSHIP where SHIP_ID=" & ID
        ...
        If dsShip.Tables(0).DefaultView.Count > 0 Then
            ...
            End If
        End If
        FirmStr = " and Ship_ID=" & ID & " Order by SHIP_CONSIGN_ID " '设计初始条件  在检索后不改变的条件  '***************要修改 或 2>1
...
Err:
    ...
    Private Sub myDataGrid(ByVal SelStr As String, ByVal Sql As String)
        ...
        Try
            '不显示的列名在最前面
            strsql = "select " & SelStr & " * from VIEW_SHIP_CONSIGN where " & Sql '******要修改

            Me.C1DBG.DataSource = Getdata(strsql, ds)  ' class dbcontrol getdata fuction
            ColNum = 4 '不显示的列数 '******要修改
            Table_Name = "VIEW_SHIP_CONSIGN" '操作的数据库表名 ''******要修改
    ...
    Private Sub SetColumnCaption()
        Me.C1DBG.Columns.Item("CLIENT").Caption = "委托人"
        Me.C1DBG.Columns.Item("CONSIGN_DATE").Caption = "委托时间"
        Me.C1DBG.Columns.Item("CONSIGN_DATE").NumberFormat = "yyyy/MM/dd"
        Me.C1DBG.Columns.Item("ITEM").Caption = "委托事项"
        Me.C1DBG.Columns.Item("CONSIGN_NAME").Caption = "委托类别名称"
        Me.C1DBG.Columns.Item("REMARK").Caption = "备注"
    End Sub
    ...
    Private Sub SetColumnWidth()
        Try
            ...
            Me.C1DBG.Splits(0).DisplayColumns.Item(4).Width() = 100
            Me.C1DBG.Splits(0).DisplayColumns.Item(5).Width() = 80
            Me.C1DBG.Splits(0).DisplayColumns.Item(6).Width() = 180
            Me.C1DBG.Splits(0).DisplayColumns.Item(7).Width() = 70
            Me.C1DBG.Splits(0).DisplayColumns.Item(8).Width() = 160
...
Err:
    ...
    Private Sub mnuFind_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles mnuFind.Click
        Dim FrmFind As New FrmFind()
        Table_Name = "View_Cargo_hatch_list" '可能要修改
        FrmFind.ShowDialog()
    ...
    Private Sub mnuDelete_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles mnuDelete.Click
        If ds.Tables(0).Rows.Count > 0 Then
            Dim FrmDelete As New FrmConsign_Delete()  '***********要修改
            ID = CType(Me.C1DBG.Columns.Item("SHIP_CONSIGN_ID").Text.ToString, Integer)
    ...
    Private Sub mnuEdit_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles mnuEdit.Click
        If ds.Tables(0).Rows.Count > 0 Then
            Dim FrmEdit As New FrmConsign_edit() '***********要修改
            Dim Row As Integer
            ID = CType(Me.C1DBG.Columns.Item("SHIP_CONSIGN_ID").Text.ToString, Integer)
            Row = Me.C1DBG.Row
            FrmEdit.ShowDialog()
    ...
    Private Sub mnuAdd_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles mnuAdd.Click
        Dim FrmAdd As New FrmConsign_add() '***********要修改
        ID = CType(Me.C1DBGV.Columns.Item("ID").Text.ToString, Integer)
        FrmAdd.ShowDialog()
        Try
            Call myDataGrid(SelectStr, SqlStr)
    ...
    Private Sub mnuQuery_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles mnuQuery.Click
        If ds.Tables(0).Rows.Count > 0 Then
            Dim FrmQuery As New FrmConsign_Query() '***********要修改
            ID = CType(Me.C1DBG.Columns.Item("SHIP_CONSIGN_ID").Text.ToString, Integer)
            FrmQuery.ShowDialog()
        End If
    End Sub
