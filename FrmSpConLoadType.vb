...
#Region " Windows 窗体设计器生成的代码 "
    ...
    Friend WithEvents cbTallyType As System.Windows.Forms.ComboBox
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(FrmSpConLoadType))
        ...
        Me.cbTallyType = New System.Windows.Forms.ComboBox
        ...
        'Label4
        '
        Me.Label4.Location = New System.Drawing.Point(372, 48)
        ...
        'cbTallyType
        '
        Me.cbTallyType.Location = New System.Drawing.Point(244, 17)
        Me.cbTallyType.Name = "cbTallyType"
        Me.cbTallyType.Size = New System.Drawing.Size(84, 20)
        Me.cbTallyType.TabIndex = 4
        '
        'btnEnter
        '
        ...
        'cbManager
        '
        Me.cbManager.Location = New System.Drawing.Point(430, 17)
        ...
        Me.dtEnd.Location = New System.Drawing.Point(394, 49)
        Me.dtEnd.Name = "dtEnd"
        ...
        Me.dtStart.Location = New System.Drawing.Point(244, 49)
        ...
        Me.Controls.Add(Me.cbTallyType)
...
#End Region
    ...
    Private Sub FrmSpConLoadType_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        '装箱类型
        Dim dsTallyType As New DataSet
        Getdata("select code_tally_type,name_tally_type from code_tally_type where tally_type_id>1", dsTallyType)
        Me.cbTallyType.DataSource = dsTallyType.Tables(0).DefaultView
        Me.cbTallyType.DisplayMember = "name_tally_type"
        Me.cbTallyType.ValueMember = "code_tally_type"
        '部门主管
    ...
    Private Sub btnEnter_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnEnter.Click
        ...
        Me.c1dbg.DataSource = Getdata("exec spconloadtype '" & Me.cbTallyType.SelectedValue & "','" & Me.dtStart.Value & "','" & Me.dtEnd.Value & "'", dsResult)
        '少于28条记录，一页打印
        ...
        If PageNumber > 0 Then
            ...
            For j = 1 To PageNumber
                If j < PageNumber Then
                    '第一页
                    If j = 1 Then
                        xlSheet = CType(xlBook.Worksheets("箱类统计1"), Excel.Worksheet)

                        If export = True Then
                            xlSheet.Application.Visible = True
                            xlBook.Worksheets("箱类统计1").select()
                        End If
                    ...
                    '第二页
                    If j = 2 Then
                        xlSheet = CType(xlBook.Worksheets("箱类统计2"), Excel.Worksheet)

                        If export = True Then
                            xlSheet.Application.Visible = True
                            xlBook.Worksheets("箱类统计2").select()
                        End If
                        If printed = True Then
                            xlSheet.Application.Visible = False
                        End If
                    ...
                    '第二页
                    If j = 3 Then
                        xlSheet = CType(xlBook.Worksheets("箱类统计3"), Excel.Worksheet)

                        If export = True Then
                            xlSheet.Application.Visible = True
                            xlBook.Worksheets("箱类统计3").select()
                        End If
                        If printed = True Then
                            xlSheet.Application.Visible = False
                        End If
                ...
                Else
                    '最后一页
                    xlSheet = CType(xlBook.Worksheets("箱类统计4"), Excel.Worksheet)

                    If export = True Then
                        xlSheet.Application.Visible = True
                        xlBook.Worksheets("箱类统计4").select()
                    End If
                    If printed = True Then
                        xlSheet.Application.Visible = False
                    End If
                ...
                End If
                '装箱类型.
                xlSheet.Cells(2, 3) = Me.cbTallyType.Text
                '统计期限开始时间
