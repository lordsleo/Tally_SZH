    ...
    Private Sub btResume_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btResume.Click
        Try
            If MsgBox("你确认要修改吗？", MsgBoxStyle.YesNo, "提示") = MsgBoxResult.Yes Then
                Call OperateHistory(G_DeptName, Now, G_User, "修改", "Code_Berth", Trim(txtID.Text), "Berth_ID")

                ds.Tables(0).Rows(0).Item("Name_Berth") = txtName.Text
                ds.Tables(0).Rows(0).Item("Dept_Code") = txtDept.SelectedValue
                ds.Tables(0).Rows(0).Item("Company") = txtCompany.Text
                ds.Tables(0).Rows(0).Item("Dock") = txtDock.Text
