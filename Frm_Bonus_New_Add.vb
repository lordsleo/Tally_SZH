...
Public Class Frm_Bonus_New_Add
...
#Region " Windows 窗体设计器生成的代码 "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(Frm_Bonus_New_Add))
        ...
        'txtDept
        '
        Me.txtDept.Location = New System.Drawing.Point(74, 7)
        ...
        'txtBonus
        '
        Me.txtBonus.Location = New System.Drawing.Point(369, 7)
        Me.txtBonus.Name = "txtBonus"
        Me.txtBonus.Size = New System.Drawing.Size(170, 20)
        Me.txtBonus.TabIndex = 0
        '
        'Label2
        '
...
#End Region
    ...
    Private Sub Frm_Bonus_New_Add_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        On Error GoTo Err
...
Err:
    ...
    Private Sub FillBONUS_CODE()
        ...
        sqldc = "select bonus_id,bonus_name from bonus_name where mark='未结束' "
    ...
    Private Sub txtDept_SelectionChangeCommitted(ByVal sender As Object, ByVal e As System.EventArgs) Handles txtDept.SelectionChangeCommitted, txtBonus.SelectionChangeCommitted
        ...
        sqlstr = "select * from VIEW_Bonus_New where dept_code='" & Dept_Code & "' and id='" & txtBonus.SelectedValue & "' Order by id desc,dept_code,xuhao "
        ...
        'Me.c1DBG.Splits(0).DisplayColumns.Item(14).Visible = False
    ...
    Private Sub SetColumnSum()
        ...
        Me.c1DBG.Columns.Item("DEPT_NAME").FooterText = "合计 共" & dsBonus.Tables(0).Rows.Count & "条"
        num = 0
        For m = 0 To dsBonus.Tables(0).Rows.Count - 1
            num = num + dsBonus.Tables(0).Rows(m)("bonus")
        Next
        Me.c1DBG.Columns.Item("bonus").FooterText = CType(num, String)
        Exit Sub
Err:
        Resume Next
    End Sub
