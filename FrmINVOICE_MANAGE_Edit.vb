...
Public Class FrmINVOICE_MANAGE_Edit
...
#Region " Windows 窗体设计器生成的代码 "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.Name = "FrmINVOICE_MANAGE_Edit"
...
#End Region
    ...
    Private Sub FrmINVOICE_MANAGE_Edit_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        On Error GoTo Err
...
Err:
    ...
    Private Sub btSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btSave.Click
        Try
            ...
            If MsgBox("你确认要修改本组发票号吗？", MsgBoxStyle.YesNo + vbExclamation, "提示") = MsgBoxResult.Yes Then
                If Len(Trim(TxtINVOICENO_BEGIN.Text)) > 0 And Len(Trim(TxtINVOICENO_END.Text)) > 0 Then
                    If end_no - begin_no > 0 Then
                        Call OperateHistory(G_DeptName, Now, G_User, "修改", "INVOICE_MANAGE", Trim(ID), "INVOICE_MANAGE_ID")
                        ds.Tables(0).Rows(0).Item("INVOICENO_BEGIN") = Trim(TxtINVOICENO_BEGIN.Text)
                        ds.Tables(0).Rows(0).Item("INVOICENO_END") = Trim(TxtINVOICENO_END.Text)
                        ds.Tables(0).Rows(0).Item("INVOICENO") = Trim(TxtINVOICENO.Text)
