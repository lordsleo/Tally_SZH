...
#Region " Windows 窗体设计器生成的代码 "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        'ToolBar
        '
        Me.ToolBar.Buttons.AddRange(New System.Windows.Forms.ToolBarButton() {Me.tbbtnFind, Me.tbbtnQuery, Me.tbbtnSep1, Me.tbbtnAdd, Me.tbbtnEdit, Me.tbbtnDelete, Me.tbbtnPrint, Me.tbbtnSep2, Me.tbbtnExport, Me.tbbtnSep3, Me.tbbtnQuit})
        ...
        'tbbtnPrint
        '
        Me.tbbtnPrint.ImageIndex = 11
        Me.tbbtnPrint.Name = "tbbtnPrint"
        Me.tbbtnPrint.Text = "考勤"
        Me.tbbtnPrint.ToolTipText = "当天新增考勤"
        '
        'tbbtnSep2
        '
...
#End Region
    ...
    '*********8.1 '***************要修改
    Private Sub FrmABSENT_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Me.WindowState = FormWindowState.Maximized
        Call preview("WL8_1") '*****************权限设计 '*************要修改模块号
        Me.Text = Me.Text & "_" & G_DeptName
        FirmStr = " Order by ABSENTDATE desc,WORK_NO "  '" Use_Comp Like '" & Trim(G_DeptCode) & "%' and Hide_Company Like '" & Trim(G_Company) & "%' order by ID DESC" '设计初始条件  在检索后不改变的条件  '***************要修改 或 2>1
        DynaStr = " DEPT_CODE= '" & G_DeptCode & "' and (datediff(MM,ABSENTDATE,GETDATE())=1 or datediff(MM,ABSENTDATE,GETDATE())=0)  and ( Code_HOLIDAY_TYPE between 1 and 89 )  " 'and DAYNIGHTMARK='01'"  '设计其它初始条件    在检索后不需要的条件 ***************要修改 或 其它条件
        SelectStr = " " ' " Top 20 "
    ...
    Private Sub myDataGrid(ByVal SelStr As String, ByVal Sql As String)
        ...
        Try
            ...
            strsql = "select " & SelStr & " * from VIEW_ABSENT_OTHER where " & Sql '******要修改

            Me.C1DBG.DataSource = Getdata(strsql, ds)
            ColNum = 4
            Table_Name = "VIEW_ABSENT_OTHER"

            For i = 0 To ColNum - 1 '设计不显示的列
                Me.C1DBG.Splits(0).DisplayColumns.Item(i).Visible = False
            Next
           
            Me.C1DBG.Columns.Item("ABSENTDATE").NumberFormat = "yyyy/MM/dd"

            Call SetColumnCaption() '设计列标题
            'Me.C1DBG.Columns.Item(4).Caption = "工号"
            'Me.C1DBG.Columns.Item(5).Caption = "姓名"
            'Me.C1DBG.Columns.Item(6).Caption = "日期"
            'Me.C1DBG.Columns.Item(7).Caption = "假别"
            'Me.C1DBG.Columns.Item(8).Caption = "部门"
    ...
    Private Sub SetColumnWidth()
        Try
            ...
            Me.C1DBG.Splits(0).DisplayColumns.Item(4).Style.HorizontalAlignment = C1.Win.C1TrueDBGrid.AlignHorzEnum.Center
            ...
            Me.C1DBG.Splits(0).DisplayColumns.Item(7).Style.HorizontalAlignment = C1.Win.C1TrueDBGrid.AlignHorzEnum.Center
            Me.C1DBG.Splits(0).DisplayColumns.Item(8).Style.HorizontalAlignment = C1.Win.C1TrueDBGrid.AlignHorzEnum.Center
...
Err:
    ...
    Private Sub mnuEdit_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles mnuEdit.Click
        If ds.Tables(0).Rows.Count > 0 Then
            Dim FrmEdit As New FrmABSENT_Edit   '***********要修改
    ...
    Private Sub mnuAdd_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles mnuAdd.Click
        Dim FrmAdd As New FrmABSENT_ADD   '***********要修改
        If ds.Tables(0).Rows.Count > 0 Then
            ID = CType(Me.C1DBG.Columns.Item("ID").Text.ToString, Integer)
        Else
            ID = -1
    ...
    Private Sub mnuPrint_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles mnuPrint.Click
        Dim FrmFind As New FrmAbsent_QBKQ
        FrmFind.ShowDialog()
        Call myDataGrid(SelectStr, SqlStr)
    End Sub
