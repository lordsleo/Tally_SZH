...
Public Class FrmSTANDBY_PERFORMANCE
...
#Region " Windows 窗体设计器生成的代码 "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(FrmSTANDBY_PERFORMANCE))
        ...
        Me.Menu = Me.MainMenu
        Me.Name = "FrmSTANDBY_PERFORMANCE"
        Me.Text = "待时绩效"
...
#End Region
    ...
    '*********8.5 '***************要修改
    Private Sub FrmSTANDBY_PERFORMANCE_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Me.WindowState = FormWindowState.Maximized
        Call preview("WL8_5") '*****************权限设计 '*************要修改模块号
        Me.Text = Me.Text & "_" & G_DeptName
        FirmStr = " Order by WORK_NO,YearMonth desc "  '设计初始条件  在检索后不改变的条件 
        DynaStr = " DEPT_CODE= '" & G_DeptCode & "' and datediff(MM,YearMonth,GETDATE())=1 "  '设计其它初始条件    在检索后不需要的条件 ***************要修改 或 其它条件
        SelectStr = " Top 50 "
    ...
    Private Sub myDataGrid(ByVal SelStr As String, ByVal Sql As String)
        ...
        Try
            '不显示的列名在最前面
            strsql = "select " & SelStr & " * from VIEW_STANDBY_PERFORMANCE where " & Sql '******要修改
            Me.C1DBG.DataSource = Getdata(strsql, ds)  ' class dbcontrol getdata fuction
            ColNum = 4 '不显示的列数 '******要修改
            Table_Name = "VIEW_STANDBY_PERFORMANCE" '操作的数据库表名 ''******要修改

            For i = 0 To ColNum - 1 '设计不显示的列
                Me.C1DBG.Splits(0).DisplayColumns.Item(i).Visible = False
            Next

            Me.C1DBG.Columns.Item(5).NumberFormat = "yyyy-MM"
    ...
    Private Sub SetColumnWidth()
        Try
            ...
            For j = 0 To Me.C1DBG.Columns.Count - 1
                ...
                If Me.C1DBG.Splits(0).DisplayColumns.Item(j).Width < 80 Then
                    Me.C1DBG.Splits(0).DisplayColumns.Item(j).Width = 80
                Else
...
Err:
    ...
    Private Sub mnuEdit_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles mnuEdit.Click
        If ds.Tables(0).Rows.Count > 0 Then
            'Dim FrmEdit As New FrmAAT_PERFORMANCE_Edit() '***********要修改
    ...
    Private Sub mnuAdd_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles mnuAdd.Click
        Dim FrmAdd As New FrmSTANDBY_PERFORMANCE_Dialog() '***********要修改

        FrmAdd.ShowDialog()

        Try
            SqlStr = " DEPT_CODE= '" & G_DeptCode & "' and datediff(MM,YearMonth,'" & GL_Date & "')=0 order by work_NO"
            Call myDataGrid(SelectStr, SqlStr)
