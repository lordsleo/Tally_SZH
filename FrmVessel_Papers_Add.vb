...
Public Class FrmVessel_Papers_Add
...
#Region " Windows 窗体设计器生成的代码 "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmVessel_Papers_Add))
        ...
        'Label15
        '
        Me.Label15.Location = New System.Drawing.Point(166, 116)
        ...
        'Label17
        '
        Me.Label17.Location = New System.Drawing.Point(166, 94)
        ...
        'Label18
        '
        Me.Label18.Location = New System.Drawing.Point(166, 72)
        ...
        'Label23
        '
        Me.Label23.Location = New System.Drawing.Point(166, 28)
        ...
        'Label24
        '
        Me.Label24.Location = New System.Drawing.Point(166, 50)
        ...
        'btnQuit
        '
        Me.btnQuit.Location = New System.Drawing.Point(281, 165)
        ...
        'btnSave
        '
        Me.btnSave.Location = New System.Drawing.Point(214, 165)
        ...
        'btnAdd
        '
        Me.btnAdd.Location = New System.Drawing.Point(147, 165)
        ...
        'TxtPCTN_NUM
        '
        Me.TxtPCTN_NUM.Location = New System.Drawing.Point(226, 114)
        ...
        'TxtOWNER_SHIP
        '
        Me.TxtOWNER_SHIP.Location = New System.Drawing.Point(226, 4)
        ...
        'TxtLOA
        '
        Me.TxtLOA.Location = New System.Drawing.Point(226, 26)
        ...
        'TxtBEAM
        '
        Me.TxtBEAM.Location = New System.Drawing.Point(226, 48)
        ...
        'TxtVESSEL_DRAFT
        '
        Me.TxtVESSEL_DRAFT.Location = New System.Drawing.Point(226, 70)
        Me.TxtVESSEL_DRAFT.MaxLength = 8
        ...
        'TxtSHIP_SPEED
        '
        Me.TxtSHIP_SPEED.Location = New System.Drawing.Point(226, 92)
        ...
        Me.TxtBUILED_DATE.Location = New System.Drawing.Point(225, 136)
        ...
        Me.GB.Location = New System.Drawing.Point(4, 195)
        Me.GB.Name = "GB"
        ...
        Me.btnSave1.Location = New System.Drawing.Point(180, 344)
        ...
        'TxtVessel_ID
        '
        Me.TxtVessel_ID.Location = New System.Drawing.Point(10, 166)
        ...
        'TxtVESSEL_TYPE
        '
        Me.TxtVESSEL_TYPE.Location = New System.Drawing.Point(64, 138)
        ...
        'TxtUSER_NAME
        '
        Me.TxtUSER_NAME.Location = New System.Drawing.Point(36, 166)
        ...
        Me.btQuit.Location = New System.Drawing.Point(248, 344)
        Me.btQuit.Name = "btQuit"
        Me.btQuit.Size = New System.Drawing.Size(65, 24)
        Me.btQuit.TabIndex = 25
        Me.btQuit.Text = "取消"
        '
        'TxtVessel_Code
        '
        Me.TxtVessel_Code.Location = New System.Drawing.Point(386, 158)
        ...
        'Label20
        '
        Me.Label20.Location = New System.Drawing.Point(350, 159)
        Me.Label20.Name = "Label20"
        Me.Label20.Size = New System.Drawing.Size(34, 20)
        Me.Label20.TabIndex = 117
        Me.Label20.Text = "船码"
        Me.Label20.TextAlign = System.Drawing.ContentAlignment.MiddleRight
        '
        'FrmVessel_Papers_Add
        '
...
#End Region
    ...
    Private Sub FrmVessel_Papers_Add_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        On Error GoTo Err
        Dim sqlstr As String
        TxtBUILED_DATE.Value = Now
...
Err:
    ...
    Private Sub btnAdd_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnAdd.Click
        ...
        Call FillLINER_ID()
        Call FillVESSEL_TYPE()
        TxtOWNER_SHIP.Text = ""
        TxtLOA.Text = ""
        TxtBEAM.Text = ""
        TxtVESSEL_DRAFT.Text = ""
        TxtSHIP_SPEED.Text = ""
        TxtPCTN_NUM.Text = ""
        TxtHATCH.Text = ""
        TxtBUILED_DATE.Value = Now
    ...
    Private Sub btnSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSave.Click
        Try
            ...
            If Getdata("select * from VESSEL where CHI_VESSEL='" & Trim(TxtCHI_VESSEL.Text) & "'", dsSave).Count > 0 Then
                MsgBox("已存在此船舶规范,请检查!", vbExclamation, "提示")
                Exit Sub
            End If
            ...
            If Len(Trim(TxtCHI_VESSEL.Text)) > 0 Then
                If MsgBox("你确认要添加数据吗？", MsgBoxStyle.YesNo + vbExclamation, "提示") = MsgBoxResult.Yes Then
                    ...
                    row("SIGN") = Trim(TxtSIGN.Text)
                    row("NATIONALITY_CODE") = Trim(TxtNATIONALITY_CODE.SelectedValue)
                    row("LINER_ID") = Trim(TxtLINER_ID.SelectedValue)
                    row("VESSEL_TYPE") = Trim(TxtVESSEL_TYPE.SelectedValue)
                    row("OWNER_SHIP") = Trim(TxtOWNER_SHIP.Text)

                    If Len(Trim(TxtLOA.Text)) > 0 Then
                        If IsNumeric(Trim(TxtLOA.Text)) Then
                            row("LOA") = Trim(TxtLOA.Text)
                        Else
                    ...
                    If Len(Trim(TxtVESSEL_DRAFT.Text)) > 0 Then
                        If IsNumeric(Trim(TxtVESSEL_DRAFT.Text)) Then
                            row("VESSEL_DRAFT") = Trim(TxtVESSEL_DRAFT.Text)
                        Else
                    ...
                    If Len(Trim(TxtSHIP_SPEED.Text)) > 0 Then
                        If IsNumeric(Trim(TxtSHIP_SPEED.Text)) Then
                            row("SHIP_SPEED") = Trim(TxtSHIP_SPEED.Text)
                        Else
                    ...
                    If Len(Trim(TxtPCTN_NUM.Text)) > 0 Then
                        If IsNumeric(Trim(TxtPCTN_NUM.Text)) Then
                            row("PCTN_NUM") = Trim(TxtPCTN_NUM.Text)
                        Else
                    ...
                    If Len(Trim(TxtTON_NET.Text)) > 0 Then
                        If IsNumeric(Trim(TxtTON_NET.Text)) Then
                            row("TON_NET") = Trim(TxtTON_NET.Text)
                        Else
                    ...
                    If Len(Trim(TxtTON_DEAD.Text)) > 0 Then
                        If IsNumeric(Trim(TxtTON_DEAD.Text)) Then
                            row("TON_DEAD") = Trim(TxtTON_DEAD.Text)
                        Else
                    ...
                    If Len(Trim(TxtDERRICK.Text)) > 0 Then
                        If IsNumeric(Trim(TxtDERRICK.Text)) Then
                            row("DERRICK") = Trim(TxtDERRICK.Text)
                        Else
                    ...
                    row("Vessel_Code") = Trim(TxtVessel_Code.Text)
                ...
                '***************编辑子表
                str = "select * from dbo.VESSEL order by VESSEL_ID desc"
                ds_sub.Reset()
                dw = Getdata(str, ds_sub)
                If ds_sub.Tables(0).Rows.Count > 0 Then
                    For i = 0 To ds_sub.Tables(0).Rows.Count - 1
                        If Trim(TxtCHI_VESSEL.Text) = CType(ds_sub.Tables(0).Rows(i).Item("CHI_VESSEL"), String) Then
                            If Trim(TxtENG_VESSEL.Text) = CType(ds_sub.Tables(0).Rows(i).Item("ENG_VESSEL"), String) Then
                                If Trim(TxtSIGN.Text) = CType(ds_sub.Tables(0).Rows(i).Item("SIGN"), String) Then
                                    TxtVessel_ID.Text = ds_sub.Tables(0).Rows(i).Item("Vessel_ID")
                                    Exit For
                                End If
                            End If
                        End If
                ...
                For i = 0 To ds1.Tables(0).Rows.Count - 1
                    ...
                    vi.DisplayValue = Trim(ds1.Tables(0).Rows(i)("DESCR"))
                    vi.Value = Trim(ds1.Tables(0).Rows(i)("Value"))
                    Me.C1DBG.Columns.Item(5).ValueItems.Values.Add(vi)
                Next
                '*******其余列赋值
                Me.C1DBG.Columns.Item(1).Value = TxtVessel_ID.Text
                ...
                Me.C1DBG.Columns.Item(7).Value = Trim(G_User)
                Me.C1DBG.Refresh()
                btnAdd.Enabled = False
                btnSave.Enabled = False
                btnQuit.Enabled = False
