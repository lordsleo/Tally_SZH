...
#End Region
    ...
    Private Sub FrmConsign_edit_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
                ...
                If Len(Trim(CmbCONSIGN_TYPE.Text)) > 0 Then
                    If Len(Trim(txtITEM.Text)) > 0 Then
                        If MsgBox("你确认要修改吗？", MsgBoxStyle.YesNo + vbExclamation, "提示") = MsgBoxResult.Yes Then
                            ...
                            ds.Tables(0).Rows(0).Item("CLIENT") = Trim(txtCLIENT.Text)
                            ds.Tables(0).Rows(0).Item("CONSIGN_DATE") = DTPCONSIGN_DATE.Value
                            ds.Tables(0).Rows(0).Item("CONSIGN_TYPE") = CmbCONSIGN_TYPE.SelectedValue
                            ds.Tables(0).Rows(0).Item("ITEM") = Trim(txtITEM.Text)
