...
#End Region
    ...
    Private Sub myDataGrid(ByVal Sql As String)
        ...
        Try
            ...
            ColNum = 1 '不显示的列数 '******要修改
            Table_Name = "View_PART" '操作的数据库表名 ''******要修改
...
Err:
    ...
    Private Sub preview(ByVal Func As String) '***************权限设计
        ...
        If Previewdv.Count > 0 Then
            If Previewdv(i)("FUNC_CODE_View") = 1 Then 'ADD 按钮可见
    ...
    Private Sub mnuFind_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles mnuFind.Click
        ...
        If Flag = 0 Then
            SelectStr = ""
            Call myDataGrid(" (" & Sql_Find & ")  " & FirmStr)   '可能要修改
            SqlStr = " (" & Sql_Find & ")  " & FirmStr '可能要修改
        ElseIf Flag = 2 Then
            SelectStr = ""
            Call myDataGrid(DynaStr & FirmStr)  '可能要修改
