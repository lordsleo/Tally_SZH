...
Public Class FrmShipAgent_Delete
...
#Region " Windows 窗体设计器生成的代码 "
    ...
    Friend WithEvents ckShip As System.Windows.Forms.CheckBox
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.ckShip = New System.Windows.Forms.CheckBox
        Me.SuspendLayout()
        '
        'txtAccount
        '
        Me.txtAccount.Location = New System.Drawing.Point(296, 92)
        Me.txtAccount.MaxLength = 40
        Me.txtAccount.Name = "txtAccount"
        Me.txtAccount.Size = New System.Drawing.Size(178, 21)
        Me.txtAccount.TabIndex = 169
        Me.txtAccount.Text = ""
        '
        'txtLinkMan
        '
        Me.txtLinkMan.Location = New System.Drawing.Point(296, 120)
        Me.txtLinkMan.MaxLength = 10
        Me.txtLinkMan.Name = "txtLinkMan"
        Me.txtLinkMan.Size = New System.Drawing.Size(178, 21)
        Me.txtLinkMan.TabIndex = 168
        Me.txtLinkMan.Text = ""
        '
        'Label6
        '
        Me.Label6.Location = New System.Drawing.Point(244, 122)
        ...
        'Label7
        '
        Me.Label7.Location = New System.Drawing.Point(244, 92)
        ...
        'txtBank
        '
        Me.txtBank.Location = New System.Drawing.Point(296, 62)
        Me.txtBank.MaxLength = 40
        Me.txtBank.Name = "txtBank"
        Me.txtBank.Size = New System.Drawing.Size(178, 21)
        Me.txtBank.TabIndex = 165
        Me.txtBank.Text = ""
        '
        'Label8
        '
        Me.Label8.Location = New System.Drawing.Point(244, 64)
        ...
        'txtEMail
        '
        Me.txtEMail.Location = New System.Drawing.Point(296, 32)
        ...
        'txtFax
        '
        Me.txtFax.Location = New System.Drawing.Point(296, 4)
        Me.txtFax.MaxLength = 20
        Me.txtFax.Name = "txtFax"
        Me.txtFax.Size = New System.Drawing.Size(178, 21)
        Me.txtFax.TabIndex = 161
        Me.txtFax.Text = ""
        '
        'Label10
        '
        Me.Label10.Location = New System.Drawing.Point(244, 6)
        ...
        'txtAddress
        '
        Me.txtAddress.Location = New System.Drawing.Point(62, 92)
        Me.txtAddress.MaxLength = 40
        Me.txtAddress.Name = "txtAddress"
        Me.txtAddress.Size = New System.Drawing.Size(178, 21)
        Me.txtAddress.TabIndex = 159
        Me.txtAddress.Text = ""
        '
        'btQuit
        '
        Me.btQuit.Location = New System.Drawing.Point(238, 178)
        Me.btQuit.Name = "btQuit"
        Me.btQuit.Size = New System.Drawing.Size(65, 24)
        Me.btQuit.TabIndex = 157
        Me.btQuit.Text = "取消"
        '
        'btResume
        '
        Me.btResume.Location = New System.Drawing.Point(170, 178)
        Me.btResume.Name = "btResume"
        Me.btResume.Size = New System.Drawing.Size(65, 24)
        Me.btResume.TabIndex = 156
        Me.btResume.Text = "确认"
        '
        'txtTelephone
        '
        Me.txtTelephone.Location = New System.Drawing.Point(62, 120)
        Me.txtTelephone.MaxLength = 40
        Me.txtTelephone.Name = "txtTelephone"
        Me.txtTelephone.Size = New System.Drawing.Size(178, 21)
        Me.txtTelephone.TabIndex = 155
        ...
        'txtCHA
        '
        Me.txtCHA.Location = New System.Drawing.Point(62, 32)
        ...
        Me.txtCode.Location = New System.Drawing.Point(62, 4)
        Me.txtCode.MaxLength = 6
        Me.txtCode.Name = "txtCode"
        Me.txtCode.Size = New System.Drawing.Size(178, 21)
        Me.txtCode.TabIndex = 148
        Me.txtCode.Text = ""
        '
        'Label1
        '
        ...
        'txtShort
        '
        Me.txtShort.Location = New System.Drawing.Point(62, 148)
        Me.txtShort.Name = "txtShort"
        Me.txtShort.Size = New System.Drawing.Size(178, 21)
        Me.txtShort.TabIndex = 171
        Me.txtShort.Text = ""
        '
        'Label11
        '
        Me.Label11.Location = New System.Drawing.Point(2, 148)
        ...
        'ckShip
        '
        Me.ckShip.Location = New System.Drawing.Point(244, 148)
        Me.ckShip.Name = "ckShip"
        Me.ckShip.Size = New System.Drawing.Size(74, 24)
        Me.ckShip.TabIndex = 172
        Me.ckShip.Text = "船代标志"
        '
        'FrmShipAgent_Delete
        '
...
#End Region
    ...
    Private Sub Frm_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        sqlstr = "select * from Code_Ship_Agent where Ship_Agent_ID=" & ID & ""

        dw = Updatedata(sqlda, sqlstr, ds)
        If dw.Count > 0 Then

            txtID.Text = ds.Tables(0).Rows(0).Item("Ship_Agent_ID")
            txtCode.Text = ds.Tables(0).Rows(0).Item("Code_Ship_Agent")
            txtCHA.Text = ds.Tables(0).Rows(0).Item("SHIPAGENT_CHA")
            txtENG.Text = ds.Tables(0).Rows(0).Item("SHIPAGENT_Eng")
            ...
            txtShort.Text = ds.Tables(0).Rows(0).Item("SHIPAGENT_SHORT")
            If IsDBNull(ds.Tables(0).Rows(0).Item("Mark")) Then
                ckShip.Checked = False
            ElseIf ds.Tables(0).Rows(0).Item("Mark") = "1" Then
                ckShip.Checked = True
            ElseIf ds.Tables(0).Rows(0).Item("Mark") = "0" Then
                ckShip.Checked = False
            End If
        End If
    ...
    Private Sub btResume_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btResume.Click
        Try
            If MsgBox("你确认要删除吗？", MsgBoxStyle.YesNo, "提示") = MsgBoxResult.Yes Then
                Call OperateHistory(G_DeptName, Now, G_User, "删除", "Code_Ship_Agent", Trim(txtID.Text), "Ship_Agent_ID")
