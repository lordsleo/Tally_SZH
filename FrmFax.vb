...
#Region " Windows 窗体设计器生成的代码 "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(FrmFax))
        ...
        Me.ToolBar.Size = New System.Drawing.Size(380, 41)
        Me.ToolBar.TabIndex = 13
        '
        'tbbtnFind
        '
        Me.tbbtnFind.ImageIndex = 0
        Me.tbbtnFind.Text = "全选"
        Me.tbbtnFind.ToolTipText = "全选"
        '
        'tbbtnQuery
        '
        ...
        Me.C1DBG.Size = New System.Drawing.Size(380, 260)
        ...
        "erticalScrollGroup=""1"" HorizontalScrollGroup=""1""><Height>256</Height><CaptionSty" & _
        ...
        " parent=""Normal"" me=""Style1"" /><ClientRect>0, 0, 376, 256</ClientRect><BorderSid" & _
        ...
        "aultRecSelWidth><ClientArea>0, 0, 376, 256</ClientArea><PrintPageHeaderStyle par" & _
...
#End Region
    ...
    Dim flag_this As Integer

    '*********1.6 '***************要修改
    Private Sub Frm_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Me.WindowState = FormWindowState.Maximized
        flag_this = 0
        Call preview("WL1_6") '*****************权限设计 '*************要修改模块号
        Me.Text = Me.Text & "_" & G_DeptName
        FirmStr = " DEPT_CODE='" & Trim(G_DeptCode) & "'  Order by statu "  '" Use_Comp Like '" & Trim(G_DeptCode) & "%' and Hide_Company Like '" & Trim(G_Company) & "%' order by ID DESC" '设计初始条件  在检索后不改变的条件  '***************要修改 或 2>1
        DynaStr = " statu = '0' and " '设计其它初始条件    在检索后不需要的条件 ***************要修改 或 其它条件
        SelectStr = " " '" Top 20 "
        ...
        If Me.C1DBG.Splits(0).Rows.Count > 0 Then
    ...
    Private Sub myDataGrid(ByVal SelStr As String, ByVal Sql As String)
        ...
        Try
            '不显示的列名在最前面
            strsql = "select " & SelStr & " * from view_fax where " & Sql '******要修改

            Me.C1DBG.DataSource = Getdata(strsql, ds)  ' class dbcontrol getdata fuction
            ColNum = 3 '不显示的列数 '******要修改
            Table_Name = "view_fax" '操作的数据库表名 ''******要修改
...
Err:
    ...
    Private Sub mnuFind_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles mnuFind.Click
        ...
        If flag_this = 0 Then
            flag_this = 1
            Me.mnuFind.Text = "未读"
            Me.ToolBar.Buttons(0).Text = "未读"
            Me.ToolBar.Buttons(0).ToolTipText = "未读"
            Sql_Find = " "
        Else
            flag_this = 0
            Me.mnuFind.Text = "全选"
            Me.ToolBar.Buttons(0).Text = "全选"
            Me.ToolBar.Buttons(0).ToolTipText = "全选"
            Sql_Find = " statu = '0' and "
        End If
    ...
    Private Sub mnuDelete_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles mnuDelete.Click
        'If ds.Tables(0).Rows.Count > 0 Then
        '    Dim FrmDelete As New FrmFax_Delete() '***********要修改
    ...
    Private Sub mnuEdit_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles mnuEdit.Click
        'If ds.Tables(0).Rows.Count > 0 Then
        '    Dim FrmEdit As New FrmFax_Edit() '***********要修改
    ...
    Private Sub mnuAdd_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles mnuAdd.Click
        'Dim FrmAdd As New FrmFax_Add() '***********要修改
        'If ds.Tables(0).Rows.Count > 0 Then
        '    ID = CType(Me.C1DBG.Columns.Item("ID").Text.ToString, Integer)
        'Else
        '    ID = -1
    ...
    Private Sub mnuQuery_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles mnuQuery.Click
        If ds.Tables(0).Rows.Count > 0 Then
            Dim FrmQuery As New FrmFax_Query   '***********要修改
            GL_FAX = CType(Me.C1DBG.Columns.Item("ID").Text.ToString, Integer)
            FrmQuery.Show()
            Try
    ...
    Private Sub C1DBG_FetchRowStyle(ByVal sender As Object, ByVal e As C1.Win.C1TrueDBGrid.FetchRowStyleEventArgs) Handles C1DBG.FetchRowStyle
        If Me.C1DBG.Columns("statu").CellValue(e.Row) = 0 Then
