...
Public Class FrmCargoDamagedDegree_Edit
...
#Region " Windows 窗体设计器生成的代码 "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.Name = "FrmCargoDamagedDegree_Edit"
        Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen
        Me.Text = "货物残损程度部位信息_编辑"
    ...
    Private Sub btResume_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btResume.Click
        Try
            If MsgBox("你确认要修改吗？", MsgBoxStyle.YesNo, "提示") = MsgBoxResult.Yes Then
                Call OperateHistory(G_DeptName, Now, G_User, "修改", "Code_CARGO_DAMAGED_Degree", Trim(txtID.Text), "CARGO_DAMAGED_Degree_ID")

                ds.Tables(0).Rows(0).Item("CODE_CARGO_DAMAGED_Degree") = Trim(txtCode.Text)
                ds.Tables(0).Rows(0).Item("CARGO_DAMAGED_Degree_CHA") = Trim(txtCHA.Text)
                ds.Tables(0).Rows(0).Item("CARGO_DAMAGED_Degree_ENG") = Trim(txtENG.Text)
                ds.Tables(0).Rows(0).Item("CARGO_DAMAGED_Degree_SHORT") = Trim(txtShort.Text)
