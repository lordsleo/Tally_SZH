...
#Region " Windows 窗体设计器生成的代码 "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(FrmReport_CON))
        ...
        Me.Name = "FrmReport_CON"
        Me.ShowInTaskbar = False
        Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen
        Me.Text = "理货月度统计综合报表（二）"
...
#End Region
    ...
    Private Sub FillDEPT_CODE()
        ...
        sqldc = "select DEPT_CODE,DEPT_NAME from DEPARTMENT where dept_code = '26.11.12'"
    ...
    Private Sub btn_enter_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_enter.Click
        Getdata("exec SPTALLY_GENERAL_CON '" & CmbDEPT_CODE.SelectedValue & "','" & DTPDate.Value & "'", ds)
        ...
        For i = 0 To 2
            ...
            Else
                If ds.Tables(0).Rows(i).Item("idd") = " 1" Then
                    ds.Tables(0).Rows(i).Item("SHIPAGENT_SHORT") = "集装箱进口"
                End If
                If ds.Tables(0).Rows(i).Item("idd") = " 2" Then
                    ds.Tables(0).Rows(i).Item("SHIPAGENT_SHORT") = "集装箱出口"
                End If
            End If
        Next

        For i = ds.Tables(0).Rows.Count - 4 To ds.Tables(0).Rows.Count - 1
            If ds.Tables(0).Rows(i).Item("idd") = "zzzz1" Then
                ds.Tables(0).Rows(i).Item("SHIPAGENT_SHORT") = "外贸进口"
            End If
            If ds.Tables(0).Rows(i).Item("idd") = "zzzz2" Then
                ds.Tables(0).Rows(i).Item("SHIPAGENT_SHORT") = "外贸出口"
            End If
            If ds.Tables(0).Rows(i).Item("idd") = "zzzz3" Then
                ds.Tables(0).Rows(i).Item("SHIPAGENT_SHORT") = "内贸进口"
            End If
            If ds.Tables(0).Rows(i).Item("idd") = "zzzz4" Then
                ds.Tables(0).Rows(i).Item("SHIPAGENT_SHORT") = "内贸进口"
            End If
        Next
        ...
        Me.C1DBG.Columns.Item("teu").Caption = "标箱"
        Me.C1DBG.Columns.Item("teu_total").Caption = "累计标箱"
    ...
    Private Sub FrmReport_CON_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        FillDEPT_CODE()
    ...
    Private Sub MakeExcel()
        ...
        Dim Col As Integer
        Dim flag As Integer
        Dim row_ii As Integer = 7

        PathStr = CurDir()
        Try
            FileCopy(PathStr + "\REPORT_GENERAL_CON.xls", PathStr + "\Report.xls")
            ...
            xlSheet.Cells(1, 1) = "中国外轮理货总公司连云港分公司集 装箱理货部"
            xlSheet.Cells(2, 10) = DTPDate.Value.Year & "年" & DTPDate.Value.Month & "月"
            flag = 4
            Me.C1DBG.MoveFirst()
            ...
            xlSheet.Cells(row_ii, 5) = "统计员："
            xlSheet.Cells(row_ii, 10) = "统2"
    ...
    Private Sub btn_print_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_print.Click
        ...
        Try
            ...
            xlSheet.Cells(1, 1) = "中国外轮理货总公司连云港分公司 " & CmbDEPT_CODE.Text
            xlSheet.Cells(2, 10) = DTPDate.Value.Year & "年" & DTPDate.Value.Month & "月"
            flag = 4
            Me.C1DBG.MoveFirst()
            For Row = 0 To ds.Tables(0).Rows.Count - 1 '填充数据
