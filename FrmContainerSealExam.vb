...
Public Class FrmContainerSealExam
...
#Region " Windows 窗体设计器生成的代码 "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(FrmContainerSealExam))
...
#End Region
    ...
    Public Shared strVessel, strVoyage As String
    ...
    Private Sub FrmContainerSealExam_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Me.WindowState = FormWindowState.Maximized
        Call preview("WL5_5") '*****************权限设计 '*************要修改模块号
        Me.Text = Me.Text & "_" & G_DeptName
        FirmStr = " and Dept_code like '" & G_DeptCode & "%' and WORKTYPE = '1' Order by ID DESC"  '" Use_Comp Like '" & Trim(G_DeptCode) & "%' and Hide_Company Like '" & Trim(G_Company) & "%' order by ID DESC" 
...
Err:
    ...
    Private Sub mnuAdd_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles mnuAdd.Click
        Dim FrmAdd As New FrmContainerSealExam_Add()  '***********要修改
        If ds.Tables(0).Rows.Count > 0 Then
            ID = CType(Me.C1DBG.Columns.Item("ID").Text.ToString, Integer)
        Else
            ID = -1
    ...
    Private Sub mnuEdit_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles mnuEdit.Click
        If ds.Tables(0).Rows.Count > 0 Then
            Dim FrmEdit As New FrmContainerSealExam_Edit() '***********要修改
            Dim Row As Integer
    ...
    Private Sub mnuDelete_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles mnuDelete.Click
        If ds.Tables(0).Rows.Count > 0 Then
            Dim FrmDelete As New FrmContainerSealExam_Delete()  '***********要修改
    ...
    Private Sub mnuExport_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles mnuExport.Click
        'Call ExportExcel()
        strVessel = Me.C1DBG.Columns("CHI_VESSEL").Text
        strVoyage = Me.C1DBG.Columns("Voyage").Text
        Dim FrmDeal As New FrmContainerSealExam_Deal()
        FrmDeal.ShowDialog()
        Try
            If FrmDeal.Flag = True Then
                Dim strFrmdealSel As String
                strFrmdealSel = " CHI_VESSEL = '" & Trim(FrmDeal.txtShip.Text) & "' AND Voyage = '" & Trim(FrmDeal.txtVoyage.Text) & "' "
                Call myDataGrid(SelectStr, strFrmdealSel)
                Call GetSheetExcel()
            End If
        Catch ex As Exception
            MsgBox(ex.Message)
    ...
    Private Sub GetSheetExcel()
        ...
        Try
            ...
            sqlNational = "SELECT SEAL_EXAM.CHI_VESSEL, SEAL_EXAM.VOYAGE, NATIONALITY_ENG, NATIONALITY_CHA FROM CODE_NATIONALITY RIGHT OUTER JOIN VESSEL ON NATIONALITY_ENG = NATIONALITY_CODE RIGHT OUTER JOIN SEAL_EXAM LEFT OUTER JOIN SSHIP ON SEAL_EXAM.CHI_VESSEL = SSHIP.CHI_VESSEL AND SEAL_EXAM.VOYAGE = SSHIP.VOYAGE ON VESSEL.ENG_VESSEL = SSHIP.ENG_VESSEL AND VESSEL.CHI_VESSEL = SSHIP.CHI_VESSEL WHERE SEAL_EXAM.VOYAGE = '" & strVoyage & "' AND SEAL_EXAM.CHI_VESSEL = '" & strVessel & "'"
            ...
            xlSheet.Cells(9, 2) = strVessel
            xlSheet.Cells(9, 5) = strVoyage
