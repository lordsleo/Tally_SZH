...
Public Class FrmCARGO_MARKS_ASSORTING
...
#Region " Windows 窗体设计器生成的代码 "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(FrmCARGO_MARKS_ASSORTING))
        ...
        Me.C1DBGV.RecordSelectorWidth = 13
        ...
        "ctorWidth=""13"" DefRecSelWidth=""13"" VerticalScrollGroup=""1"" HorizontalScrollGroup" & _
        "=""1""><ClientRect>0, 0, 164, 285</ClientRect><BorderSide>0</BorderSide><CaptionSt" & _
        ...
        ">1</horzSplits><Layout>None</Layout><DefaultRecSelWidth>13</DefaultRecSelWidth><" & _
        "ClientArea>0, 0, 164, 285</ClientArea><PrintPageHeaderStyle parent="""" me=""Style1" & _
        ...
        Me.C1DBG.RecordSelectorWidth = 13
        ...
        "vertSplits><horzSplits>1</horzSplits><Layout>None</Layout><DefaultRecSelWidth>13" & _
        ...
        'ToolBar
        '
        Me.ToolBar.Buttons.AddRange(New System.Windows.Forms.ToolBarButton() {Me.tbbtnFind, Me.tbbtndo, Me.tbbtnQuery, Me.tbbtnAdd, Me.tbbtnEdit, Me.tbbtnDelete, Me.tbbtnSep2, Me.tbbtnPrint, Me.tbbtnExport, Me.tbbtnSep3, Me.tbbtnQuit})
        ...
        Me.Menu = Me.MainMenu
        Me.Name = "FrmCARGO_MARKS_ASSORTING"
        Me.Text = "分标志单"
...
#End Region
    ...
    Private Sub FrmCARGO_MARKS_ASSORTING_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
...
Err:
    ...
    Private Sub myDataGrid(ByVal SelStr As String, ByVal Sql As String)
        ...
        Try
            '不显示的列名在最前面
            strsql = "select " & SelStr & " *  from VIEW_CARGO_MARKS_ASSORT  where " & Sql '******要修改
