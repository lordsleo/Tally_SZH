...
Public Class FrmCargoDamaged_Add
...
#Region " Windows 窗体设计器生成的代码 "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        'btQuit
        '
        Me.btQuit.Location = New System.Drawing.Point(154, 116)
        ...
        'btSave
        '
        Me.btSave.Location = New System.Drawing.Point(86, 116)
        ...
        'btAdd
        '
        Me.btAdd.Location = New System.Drawing.Point(18, 116)
        Me.btAdd.Name = "btAdd"
        Me.btAdd.Size = New System.Drawing.Size(65, 24)
        Me.btAdd.TabIndex = 116
        Me.btAdd.Text = "清空"
        '
        'txtENG
        '
...
Err:
    ...
    Private Sub btSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btSave.Click
        Try
            ...
            If Getdata("select * from CODE_CARGO_DAMAGED where CODE_CARGO_DAMAGED='" & Trim(txtCode.Text) & "'", dsSave).Count > 0 Then
                MsgBox("可能已存在此货物残损用语信息,请注意检查!")
                Exit Sub
            End If
            If Len(Trim(txtCode.Text)) > 0 And Len(Trim(txtCHA.Text)) > 0 Then
                ...
                row("CODE_CARGO_DAMAGED") = Trim(txtCode.Text)
                row("CARGO_DAMAGED_CHA") = Trim(txtCHA.Text)
                row("CARGO_DAMAGED_ENG") = Trim(txtENG.Text)
                row("CARGO_DAMAGED_SHORT") = Trim(txtShort.Text)
                ds.Tables(0).Rows.Add(row)
                sqlda.Update(ds)
                Me.Close()
            Else
                MsgBox("用语代码不能为空!", MsgBoxStyle.Critical, "提示")
            End If
