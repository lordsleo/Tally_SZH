...
#Region " Windows 窗体设计器生成的代码 "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(FrmGraphtest))
        ...
        Me.GB.Name = "GB"
        Me.GB.Size = New System.Drawing.Size(540, 370)
        Me.GB.TabIndex = 3
        Me.GB.TabStop = False
        '
        'plMobile
        ...
        'c1Mobile
        '
        Me.c1Mobile.BorderStyle = System.Windows.Forms.BorderStyle.Fixed3D
        ...
        Me.c1Mobile.Images.Add(CType(resources.GetObject("resource"), System.Drawing.Image))
        ...
        Me.c1Mobile.PropBag = "<?xml version=""1.0""?><Blob><Styles type=""C1.Win.C1TrueDBGrid.Design.ContextWrappe" & _
        ...
        "=""1""><Height>116</Height><CaptionStyle parent=""Style2"" me=""Style10"" /><EditorSty" & _
        ...
        ", 0, 442, 116</ClientRect><BorderSide>0</BorderSide><BorderStyle>Sunken</BorderS" & _
        ...
        "</Layout><DefaultRecSelWidth>16</DefaultRecSelWidth><ClientArea>0, 0, 442, 116</" & _
        ...
        Me.plDrawPlat.Size = New System.Drawing.Size(532, 250)
        ...
        Me.textInput.Size = New System.Drawing.Size(88, 52)
        ...
        Me.picBoxDraw.Size = New System.Drawing.Size(504, 245)
        ...
        Me.GBV.Name = "GBV"
        Me.GBV.Size = New System.Drawing.Size(174, 370)
        Me.GBV.TabIndex = 2
        ...
        Me.ToolBarV.Location = New System.Drawing.Point(3, 326)
        ...
        Me.btResure.Anchor = CType(((System.Windows.Forms.AnchorStyles.Bottom Or System.Windows.Forms.AnchorStyles.Left) _
                    Or System.Windows.Forms.AnchorStyles.Right), System.Windows.Forms.AnchorStyles)
        Me.btResure.Location = New System.Drawing.Point(126, 301)
        ...
        Me.txtVoyage.Anchor = CType(((System.Windows.Forms.AnchorStyles.Bottom Or System.Windows.Forms.AnchorStyles.Left) _
                    Or System.Windows.Forms.AnchorStyles.Right), System.Windows.Forms.AnchorStyles)
        Me.txtVoyage.Location = New System.Drawing.Point(36, 301)
        ...
        Me.txtShipName.Anchor = CType(((System.Windows.Forms.AnchorStyles.Bottom Or System.Windows.Forms.AnchorStyles.Left) _
                    Or System.Windows.Forms.AnchorStyles.Right), System.Windows.Forms.AnchorStyles)
        Me.txtShipName.Location = New System.Drawing.Point(36, 277)
        ...
        "onHeight=""18"" ColumnFooterHeight=""18"" MarqueeStyle=""DottedCellBorder"" RecordSele" & _
        "ctorWidth=""16"" DefRecSelWidth=""16"" VerticalScrollGroup=""1"" HorizontalScrollGroup" & _
        "=""1""><Height>291</Height><CaptionStyle parent=""Style2"" me=""Style10"" /><EditorSty" & _
        "le parent=""Editor"" me=""Style5"" /><EvenRowStyle parent=""EvenRow"" me=""Style8"" /><F" & _
        "ilterBarStyle parent=""FilterBar"" me=""Style13"" /><FooterStyle parent=""Footer"" me=" & _
        """Style3"" /><GroupStyle parent=""Group"" me=""Style12"" /><HeadingStyle parent=""Headi" & _
        "ng"" me=""Style2"" /><HighLightRowStyle parent=""HighlightRow"" me=""Style7"" /><Inacti" & _
        ...
        " /><RecordSelectorStyle parent=""RecordSelector"" me=""Style11"" /><SelectedStyle pa" & _
        "rent=""Selected"" me=""Style6"" /><Style parent=""Normal"" me=""Style1"" /><ClientRect>0" & _
        ", 0, 164, 291</ClientRect><BorderSide>0</BorderSide><BorderStyle>Sunken</BorderS" & _
        "tyle></C1.Win.C1TrueDBGrid.MergeView></Splits><NamedStyles><Style parent="""" me=""" & _
        "Normal"" /><Style parent=""Normal"" me=""Heading"" /><Style parent=""Heading"" me=""Foot" & _
        "er"" /><Style parent=""Heading"" me=""Caption"" /><Style parent=""Heading"" me=""Inactiv" & _
        "e"" /><Style parent=""Normal"" me=""Selected"" /><Style parent=""Normal"" me=""Editor"" /" & _
        ...
        "r"" /><Style parent=""Normal"" me=""FilterBar"" /><Style parent=""Caption"" me=""Group"" " & _
        "/></NamedStyles><vertSplits>1</vertSplits><horzSplits>1</horzSplits><Layout>None" & _
        "</Layout><DefaultRecSelWidth>16</DefaultRecSelWidth><ClientArea>0, 0, 164, 291</" & _
        "ClientArea><PrintPageHeaderStyle parent="""" me=""Style14"" /><PrintPageFooterStyle " & _
        "parent="""" me=""Style15"" /></Blob>"
        '
        'MenuItem1
...
#End Region
    ...
    'int ColNum; 
    '//不显示的列数 
    'public static string InOutCode; 
    'DataSet ds_ship_statu = new DataSet(); 
    '//船舶状态 
    'int oldShip_id; 
    '//老的ship-id 
    'bool dotLine; 
    '//判断是否是点画线 
    'float[] dashValues = { 1, 2, 15, 2 }; 
    '//定义锁线样式 
    'bool dashLine; 
    '//判断是否是锁线 
    'Font fnt_all = new Font("宋体", 8, FontStyle.Bold); 
    'FontStyle fsty = new FontStyle(); 
    ...
    Private Sub FrmCargofeestat_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        'this.Text = this.Text + "_" + G_DeptName; 
        'SortShip = " Order by Ship_Statu,Dept_Code,id desc "; 
        '//默认的排序 
        'FirmShip = "where DEPT_CODE LIKE '" + G_DeptCode + "%' and code_goods<>'2' "; 
        '//船舶不变的条件设计 
        'SqlStrShip = "where (DEPT_CODE LIKE '" + G_DeptCode + "%' and SHIP_STATU in ('2','3')) and code_goods<>'2' "; 
        '//OR (Ship_Statu in ('1') and len(ltrim(BerthNo))=0) " 
        'myDataGridShip(SqlStrShip + inoutstr + SortShip); 
        '//*****************调用航次信息 
        'this.C1DBGV.SelectedStyle.BackColor = System.Drawing.Color.CornflowerBlue; 
...
Err:
    ...
    Private Sub printpageeventhandler(ByVal obj As System.Object, ByVal ev As PrintPageEventArgs)
        ...
        If Microsoft.VisualBasic.Left(ev.PageSettings.PaperSize.PaperName, 2) = "A4" Then
            ...
            g.DrawLine(pen, disToLeft + 80 + 50, 787 - 40 + 0 + 200, disToLeft + 500, 787 - 40 + 0 + 200)
            g.DrawLine(pen, disToLeft + 80 + 50, 787 - 40 + 25 + 200, disToLeft + 500, 787 - 40 + 25 + 200)

            g.DrawString("Master/Chief Officer:", f, Brushes.Black, disToLeft + 60 + 500, 787 - 40 + 15 + 200)
            g.DrawLine(pen, disToLeft + 60 + 500 + 100 + 20, 787 - 40 + 25 + 200, disToLeft + 60 + 500 + 50 + 350, 787 - 40 + 25 + 200)
        ...
        If Microsoft.VisualBasic.Left(ev.PageSettings.PaperSize.PaperName, 2) = "B4" Then
            ...
            '画最下面的remark
            g.DrawString("Remarks:", f, Brushes.Black, disToLeft + 80, 787 - 30 + 200)
            g.DrawLine(pen, disToLeft + 80 + 50, 787 - 40 + 0 + 200, disToLeft + 500 + 157, 787 - 40 + 0 + 200)
        ...
        If blDrawing Then
            ...
            If e.X <> curPosX Or e.Y <> curPosY Then
                Select Case pushBtName
                    Case "line"
                        Dim ln As Graph.Line
                        ln = New FrmGraphtest.Graph.Line
                    ...
                    Case "rect"
                        Dim rt As Graph.Rect
                        rt = New FrmGraphtest.Graph.Rect
