...
Public Class FrmBILL_RECEIVABLE_Query
...
#Region " Windows 窗体设计器生成的代码 "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.txtACCONT_ARREARAGE.TabIndex = 5
        ...
        Me.txtACCOUNT_OCCUR.TabIndex = 3
        ...
        'btQuit
        '
        Me.btQuit.Location = New System.Drawing.Point(76, 132)
        ...
        Me.CmbACCOUNT_COMPANY.TabIndex = 1
        '
        'Label5
        '
        ...
        Me.TxtACCOUNT_IN.TabIndex = 4
        Me.TxtACCOUNT_IN.Text = ""
        '
        'FrmBILL_RECEIVABLE_Query
        '
        Me.AutoScaleBaseSize = New System.Drawing.Size(6, 14)
        Me.ClientSize = New System.Drawing.Size(216, 165)
        Me.Controls.AddRange(New System.Windows.Forms.Control() {Me.TxtACCOUNT_IN, Me.CmbACCOUNT_COMPANY, Me.txtACCONT_ARREARAGE, Me.txtACCOUNT_OCCUR, Me.txtACCOUNT_LAST, Me.Label4, Me.Label3, Me.Label2, Me.Label1, Me.btQuit, Me.txtID, Me.Label5})
        Me.FormBorderStyle = System.Windows.Forms.FormBorderStyle.FixedSingle
        Me.MaximizeBox = False
        Me.MinimizeBox = False
        Me.Name = "FrmBILL_RECEIVABLE_Query"
...
#End Region
    ...
    Private Sub FrmBILL_RECEIVABLE_Query_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        On Error GoTo Err
...
Err:
    ...
    Private Sub btResume_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
        Try
            If MsgBox("你确认要修改吗？", MsgBoxStyle.YesNo, "提示") = MsgBoxResult.Yes Then
                Call OperateHistory(G_DeptName, Now, G_User, "修改", "BILL_RECEIVABLE", Trim(txtID.Text), "BILL_RECEIVABLE_ID")
