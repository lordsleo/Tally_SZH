...
Public Class FrmCARGO_DAILY_REPORT_DO
...
#Region " Windows 窗体设计器生成的代码 "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(FrmCARGO_DAILY_REPORT_DO))
        ...
        Me.Name = "FrmCARGO_DAILY_REPORT_DO"
...
#End Region
    ...
    Private Sub FrmCARGO_DAILY_REPORT_DO_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Me.Height = 130
            ...
            If RBeng.Checked = True Then
                ...
                If dstmp.Tables(0).Rows.Count > 0 Then
                    If MsgBox("现有条件的日报已存在，是否重新统计？", MsgBoxStyle.YesNo, "提示") = MsgBoxResult.Yes Then
                        ExecSql("exec sp_daily_report_eng_gl_new '" & Ship_ID & "','" & DTPdate.Value & "','" & CombWORK_TIME.SelectedValue & "' ")
                        st = "select id,gbno from report_his1 where ship_id='" & Ship_ID & "' and datediff(dd,workdate,'" & DTPdate.Value & "')=0 and worktime='" & CombWORK_TIME.SelectedValue & "' AND other='0' "
                        Getdata(st, dstmp)
                    End If
                Else
