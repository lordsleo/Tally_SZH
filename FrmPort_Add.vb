...
#Region " Windows 窗体设计器生成的代码 "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        ", 18, 340, 128</ClientRect><BorderSide>0</BorderSide><CaptionStyle parent=""Style" & _
    ...
    Private Sub btSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btSave.Click
        Try
            ...
            If Len(Trim(txtCode.Text)) > 0 And Len(Trim(txtCHA.Text)) > 0 Then
                ...
                updatetxt = "insert into code_port(code_port,port_cha,port_eng,code_nationality,port_short)values(''" & Trim(txtCode.Text) & "'',''" & Trim(txtCHA.Text) & "'',''" & Trim(txtENG.Text) & "'',''" & Trim(txtNationality.SelectedValue) & "'',''" & Trim(txtShort.Text) & "'',''" & Trim(G_User) & "'')"
