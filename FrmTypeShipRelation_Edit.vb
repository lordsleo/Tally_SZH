...
Public Class FrmTypeShipRelation_Edit
...
#Region " Windows 窗体设计器生成的代码 "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        'txtShipOwner
        '
        Me.txtShipOwner.Location = New System.Drawing.Point(82, 36)
        ...
        'btQuit
        '
        Me.btQuit.Location = New System.Drawing.Point(119, 92)
        ...
        'btSave
        '
        Me.btSave.Location = New System.Drawing.Point(51, 92)
        ...
        'txtCode
        '
        Me.txtCode.Location = New System.Drawing.Point(82, 64)
        ...
        'txtNO
        '
        Me.txtNO.Location = New System.Drawing.Point(82, 6)
        ...
        '
        'FrmTypeShipRelation_Edit
        '
        Me.AutoScaleBaseSize = New System.Drawing.Size(6, 14)
        Me.ClientSize = New System.Drawing.Size(234, 119)
        Me.Controls.AddRange(New System.Windows.Forms.Control() {Me.txtShipOwner, Me.btQuit, Me.btSave, Me.txtCode, Me.Label5, Me.Label4, Me.txtNO, Me.Label3, Me.txtID})
        Me.FormBorderStyle = System.Windows.Forms.FormBorderStyle.FixedSingle
        Me.MaximizeBox = False
        Me.MinimizeBox = False
        Me.Name = "FrmTypeShipRelation_Edit"
        Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen
        Me.Text = "箱号与船公司箱型对照表_编辑"
    ...
    Private Sub btSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btSave.Click
        Try
            If MsgBox("你确认要修改吗？", MsgBoxStyle.YesNo, "提示") = MsgBoxResult.Yes Then
                Call OperateHistory(G_DeptName, Now, G_User, "修改", "CODE_TYPE_SHIP_RELATION", Trim(txtID.Text), "CODE_TYPE_SHIP_RELATION_ID")

                ds.Tables(0).Rows(0).Item("CONTAINER_NO") = Trim(txtNO.Text)
                ds.Tables(0).Rows(0).Item("CODE_CON_TYPE") = Trim(txtCode.Text)
