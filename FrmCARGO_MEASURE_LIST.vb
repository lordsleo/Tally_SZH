...
Public Class FrmCARGO_MEASURE_LIST
...
#Region " Windows 窗体设计器生成的代码 "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(FrmCARGO_MEASURE_LIST))
        ...
        ", 0, 164, 285</ClientRect><BorderSide>0</BorderSide><CaptionStyle parent=""Style2" & _
        ...
        Me.GB.Name = "GB"
        Me.GB.Size = New System.Drawing.Size(542, 397)
        Me.GB.TabIndex = 5
        Me.GB.TabStop = False
        '
        'Label
        ...
        Me.ToolBar.Size = New System.Drawing.Size(536, 38)
        ...
        'btResure
        '
        Me.btResure.Location = New System.Drawing.Point(130, 332)
        ...
        'txtVoyage
        '
        Me.txtVoyage.Location = New System.Drawing.Point(40, 332)
        ...
        'txtShipName
        '
        Me.txtShipName.Location = New System.Drawing.Point(40, 308)
...
#End Region
    ...
    Private Sub FrmCARGO_MEASURE_LIST_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
...
Err:
    ...
    Private Sub myDataGrid(ByVal SelStr As String, ByVal Sql As String)
        ...
        Try
            '不显示的列名在最前面
            strsql = "select " & SelStr & " *  from VIEW_CARGO_MEASURE_LIST  where " & Sql '******要修改
...
Err:
    ...
    Private Sub mnuDelete_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles mnuDelete.Click
        If ds.Tables(0).Rows.Count > 0 Then
            Dim FrmDelete As New FrmCARGO_MEASURE_LIST_DELETE() '***********要修改
