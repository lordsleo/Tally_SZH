...
Public Class FrmCARGO_MARKS_ASSORTING_EDIT
...
#Region " Windows 窗体设计器生成的代码 "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.TxtAMOUNT_SHORT.Location = New System.Drawing.Point(282, 136)
        ...
        'Label10
        '
        Me.Label10.Location = New System.Drawing.Point(212, 138)
        ...
        Me.TxtAMOUNT_OVER.Location = New System.Drawing.Point(282, 110)
        ...
        'CombPACK_ASSORT
        '
        Me.CombPACK_ASSORT.Location = New System.Drawing.Point(282, 84)
        ...
        'BTOK
        '
        Me.BTOK.Location = New System.Drawing.Point(134, 174)
        Me.BTOK.Name = "BTOK"
        ...
        'TxtAMOUNT_ASSORT
        '
        Me.TxtAMOUNT_ASSORT.Location = New System.Drawing.Point(282, 58)
        ...
        'TxtAMOUNT
        '
        Me.TxtAMOUNT.Location = New System.Drawing.Point(282, 10)
...
#End Region
    ...
    Private Sub FrmCARGO_MARKS_ASSORTING_EDIT_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        On Error GoTo Err
                ...
                If Len(Trim(TxtMARK.Text)) > 0 Then
                    If Len(Trim(CombCODE_GOODS.SelectedValue)) > 0 Then
                        ...
                        If Len(Trim(TxtNO.Text)) > 0 Then
                            ...
                            dw = Getdata("select * from CARGO_MARKS_ASSORTING where  blno='" & Trim(TxtBLNO.Text) & "' and mark='" & Trim(TxtMARK.Text) & "' and ship_id='" & Ship_ID & "' and cargo_marks_id<>'" & ID & "'", dskey)
                            ...
                            Else
                                If MsgBox("确认要修改吗？", MsgBoxStyle.YesNo, "提示") = MsgBoxResult.Yes Then
                                    ...
                                    OperateHistory(G_DeptName, Now, G_User, "编辑", "CARGO_MARKS_ID", ID, "CARGO_MARKS_ID")
                                    ...
                                    ds.Tables(0).Rows(0).Item("PACK_assort") = IIf(Len(Trim(CombPACK_ASSORT.SelectedValue)) > 0, Trim(CombPACK_ASSORT.SelectedValue), "000")
                                    ds.Tables(0).Rows(0).Item("AMOUNT") = Trim(TxtAMOUNT.Text)
                                    ds.Tables(0).Rows(0).Item("TALLY_AMOUNT") = Trim(TxtTALLY_AMOUNT.Text)
                                    ds.Tables(0).Rows(0).Item("AMOUNT_assort") = Trim(TxtAMOUNT_ASSORT.Text)
                                    ds.Tables(0).Rows(0).Item("amount_over") = Trim(TxtAMOUNT_OVER.Text)
                                    ds.Tables(0).Rows(0).Item("amount_short") = Trim(TxtAMOUNT_SHORT.Text)
