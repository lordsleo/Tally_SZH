...
Public Class FrmCARGO_DAMAGED_List
...
#Region " Windows 窗体设计器生成的代码 "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(FrmCARGO_DAMAGED_List))
        ...
        Me.GB.Name = "GB"
        Me.GB.Size = New System.Drawing.Size(540, 397)
        Me.GB.TabIndex = 5
        Me.GB.TabStop = False
        '
        'Label
        ...
        Me.Label1.Text = "船名"
        '
        'FrmCARGO_DAMAGED_List
        '
        Me.AutoScaleBaseSize = New System.Drawing.Size(6, 14)
        Me.ClientSize = New System.Drawing.Size(714, 397)
        Me.Controls.AddRange(New System.Windows.Forms.Control() {Me.GB, Me.GBV})
        Me.Menu = Me.MainMenu
        Me.Name = "FrmCARGO_DAMAGED_List"
        Me.Text = "残损单"
...
#End Region
    ...
    Private Sub FrmCARGO_DAMAGED_List_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
...
Err:
    ...
    Private Sub myDataGrid(ByVal SelStr As String, ByVal Sql As String)
        ...
        Try
            '不显示的列名在最前面
            strsql = "select " & SelStr & " *  from VIEW_CARGO_DAMAGED_List  where " & Sql '******要修改
