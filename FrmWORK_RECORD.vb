...
#Region " Windows 窗体设计器生成的代码 "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmWORK_RECORD))
        ...
        Me.GB.Name = "GB"
        Me.GB.Size = New System.Drawing.Size(476, 397)
        Me.GB.TabIndex = 4
        Me.GB.TabStop = False
        '
        'Label
        ...
        Me.ToolBar.Size = New System.Drawing.Size(470, 41)
...
#End Region
    ...
    Private Sub FrmWORK_RECORD_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
...
Err:
    ...
    Private Sub myDataGrid(ByVal SelStr As String, ByVal Sql As String)
        ...
        Try
            ...
            Me.C1DBG.Columns.Item("RECORD_DAY").NumberFormat = "yyyy/MM/dd"
...
Err:
    ...
    Private Sub mnuDelete_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles mnuDelete.Click
        If ds.Tables(0).Rows.Count > 0 Then
            Dim FrmDelete As New FrmWORK_RECORD_DELETE   '***********要修改
